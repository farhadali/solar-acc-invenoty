        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('report-stock-possition')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                         <select id="_with_zero" class="form-control  _with_zero " name="_with_zero"  >
                           <option value="1" <?php if(isset($previous_filter["_with_zero"])): ?> <?php if($previous_filter["_with_zero"] ==1): ?> selected <?php endif; ?> <?php endif; ?> >Without Zero QTY</option>
                           <option value="0" <?php if(isset($previous_filter["_with_zero"])): ?> <?php if($previous_filter["_with_zero"] ==0): ?> selected <?php endif; ?> <?php endif; ?>>With Zero QTY</option>
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="<?php echo e(url('reset-stock-possition')); ?>" class="btn btn-danger form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                        </div>
                        <br><br>
                     </div>
                    <?php echo Form::close(); ?>
...
$(document).find('._item_category').on('change',function(){
    ...
    function _category_base_items(_category_id){
      var request = $.ajax({
          url: "<?php echo e(url('stock-possition-cat-item')); ?>",
          method: "GET",
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/backend/inventory-report/filter_stock_possition.blade.php ENDPATH**/ ?>