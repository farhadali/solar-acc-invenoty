          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
                 <a target="__blank" href="<?php echo e(url('sales-order/print')); ?>/<?php echo e($data->id); ?>" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
             ...
             <li class="breadcrumb-item ">
              ...
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="<?php echo e(route('sales-order.index')); ?>"> <i class="nav-icon fas fa-list"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="<?php echo e(url('sales-order/update')); ?>" method="POST" class="purchase_form" >
                <?php echo csrf_field(); ?>
                      <div class="row">
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            ...
                                            <tr class="_purchase_row">
                                              ...
                                              <td class="display_none">
                                                ...
                                                <input type="number" name="_base_rate[]" min="0" step="any" class="form-control _base_rate " value="<?php echo e($detail->_items->_sale_rate ?? 0); ?>"  readonly>
                                              </td>
                                              <td class="">
                                              ...
                                              <td>
                                                <input type="number" name="_qty[]" class="form-control text-right _qty _common_keyup"  value="<?php echo e($detail->_qty ?? 0); ?>" >
                                              </td>
                                              <td>
                                                <input type="number" name="_rate[]" class="form-control _rate text-right _common_keyup" value="<?php echo e($detail->_rate ?? 0); ?>" >
                                              </td>
                              ...
                              <td style="width: 70%;border:0px;">
                                <?php if($_print = Session::get('_print_value')): ?>
                                    ...
                                    <?php if($_master_id = Session::get('_master_id')): ?>
                                     <input type="hidden" name="_master_id" value="<?php echo e(url('sales-order/print')); ?>/<?php echo e($_master_id); ?>" class="_master_id">
                        ...
                        for (var i = 0; i < data.length; i++) {
                         search_html += `<tr class="search_row_item" >
                                  ...
                                  <input type="hidden" name="_main_unit_text" class="_main_unit_text" value="${data[i]._units?._name}">
                                   ...
                                   <td>${ data[i]?._balance} ${data[i]._units?._name}</td>
                                   </tr>`;
                        }                         
...
var _purchase_row_single =`<tr class="_purchase_row">
                                              ...
                                              <td>
                                                <input type="number" name="_qty[]" class="form-control _qty text-right _common_keyup" >
                                              </td>
                                              <td>
                                                <input type="number" name="_rate[]" class="form-control _rate text-right _common_keyup" >
                                              </td>
                                              
                                               
                                              <td>
                                                <input type="number" name="_value[]" class="form-control _value text-right" readonly >
                                              </td>
                                              <?php if(sizeof($permited_branch)>1): ?>
                                              <td>
                                                <select class="form-control  _main_branch_id_detail" name="_main_branch_id_detail[]"  required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/sales-order/edit.blade.php ENDPATH**/ ?>