              ...
              <?php echo $__env->make('backend.message.voucher-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
                  ...
                  <div class="col-md-6 ">
                    <div class="d-flex right" style="float: right;">
                        ...
                        <a title="Add New" class="btn btn-sm btn-success mr-3" href="<?php echo e(route('voucher.create')); ?>"> <i class="nav-icon fas fa-plus"></i> </a>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('voucher-print')): ?>
                         ...
                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('voucher-list')): ?>
                           ...
                           <a class="btn  btn-sm btn-primary" title="List" href="<?php echo e(route('voucher.index')); ?>"> 
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/voucher/edit.blade.php ENDPATH**/ ?>