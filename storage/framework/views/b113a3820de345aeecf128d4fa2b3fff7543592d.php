                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('companies-delete')): ?>
                                 <?php echo Form::open(['method' => 'DELETE','route' => ['companies.destroy', $data->id],'style'=>'display:inline']); ?>
                               ...
                               <?php endif; ?> 
                              <a  type="button" 
                                  href="<?php echo e(route('companies.show',$data->id)); ?>"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>

                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('companies-edit')): ?>
                                  <a  type="button" 
                                  href="<?php echo e(route('companies.edit',$data->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/hrm/companies/index.blade.php ENDPATH**/ ?>