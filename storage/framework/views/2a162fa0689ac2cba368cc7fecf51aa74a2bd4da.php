        ...
        <div class="row mb-2">
          <div class=" col-sm-8 ">
            <h1 class="m-0 _page_name">
              <a  href="<?php echo e(route('inter-project-voucher.index')); ?>"> <?php echo $page_name ?? ''; ?> </a>    
              
              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inter-project-voucher-create')): ?>
            <a title="Add New" class="btn  btn-sm btn-info" href="<?php echo e(route('inter-project-voucher.create')); ?>"> <i class="nav-icon fas fa-plus"></i> <?php echo e(__('label.Add New')); ?> </a>
                <?php endif; ?> 
          <a class="btn btn-sm btn-default mr-3" href="<?php echo e(route('inter-project-voucher.show',$data->id)); ?>"><i class="nav-icon fas fa-eye"></i></a>
            ...
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item active">
               ...
               <?php endif; ?>
              <li class="breadcrumb-item active">
                 <a class="btn btn-sm btn-default" title="List" href="<?php echo e(route('inter-project-voucher.index')); ?>">Inner Project Voucher List</a>
               </li>
            </ol>
          </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php echo Form::model($data, ['method' => 'PATCH','class'=>'voucher-form','route' => ['inter-project-voucher.update', $data->id]]); ?>
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          <thead>
                                            ...
                                            <th class="dr_organization_title">DR. <?php echo e(__('label.organization')); ?></th>
                                            ...
                                            <th class="cr_organization_title">CR. <?php echo e(__('label.organization')); ?></th>
                                          ...
                                          <?php endif; ?>
                                              ...
                                              <td>
                                                <select class="form-control " name="_dr_organization_id_detail[]" required >
                                                   ...
                                                   <option value="<?php echo e($val->id); ?>" <?php if($_dr_organization_id_detail==$val->id): ?> selected <?php endif; ?> ><?php echo e($val->id ?? ''); ?> - <?php echo e($val->_name ?? ''); ?></option>
                                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                   <?php endif; ?>
                                                 </select>
                                              </td>
                                              <td>
                                                <select class="form-control width_150_px _dr_branch_id_detail" name="_dr_branch_id_detail[]"  required>
                                                  ...
                                                  <option value="<?php echo e($branch->id); ?>"  <?php if($_dr_branch_id_detail == $branch->id): ?> selected <?php endif; ?>   ><?php echo e($branch->_name ?? ''); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                  <?php endif; ?>
                                                </select>
                                              </td>
                                                ...
                                                <td>
                                                 <select class="form-control width_150_px _dr_cost_center" name="_dr_cost_center[]" required >
                                                  ...
                                                  <option value="<?php echo e($costcenter->id); ?>"
                                                    <?php if($_dr_cost_center == $costcenter->id): ?> selected <?php endif; ?>   > <?php echo e($costcenter->_name ?? ''); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                  <?php endif; ?>
                                                </select>
                                              </td>
                                              ...
                                              <td>
                                                <select class="form-control " name="_cr_organization_id_detail[]" required >
                                                   <?php $__empty_2 = true; $__currentLoopData = $permited_organizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                   <option value="<?php echo e($val->id); ?>" <?php if($_cr_organization_id_detail==$val->id): ?> selected <?php endif; ?> ><?php echo e($val->id ?? ''); ?> - <?php echo e($val->_name ?? ''); ?></option>
                                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                   <?php endif; ?>
                                                 </select>
                                              </td>
                                              <td>
                                                <select class="form-control width_150_px _cr_branch_id_detail" name="_cr_branch_id_detail[]"  required>
                                                  ...
                                                  <option value="<?php echo e($branch->id); ?>"
                                                    <?php if($branch->id==$_cr_branch_id_detail): ?> selected <?php endif; ?>
                                                ...
                                                <td>
                                                 <select class="form-control width_150_px _cr_cost_center" name="_cr_cost_center[]" required >
                                                  ...
                                                  <?php $__empty_2 = true; $__currentLoopData = $permited_costcenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $costcenter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                  <option value="<?php echo e($costcenter->id); ?>"
                                                     <?php if($costcenter->id==$_cr_cost_center): ?> selected <?php endif; ?>
...
$(document).on("change","._voucher_type",function(){
 ...
 var single_row =  `<tr class="_voucher_row">
                                              ...
                                              <td>
                                                <input type="number" name="_amount[]" class="form-control  _amount"  value="<?php echo e(old('_amount',0)); ?>">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/inter-project-voucher/edit.blade.php ENDPATH**/ ?>