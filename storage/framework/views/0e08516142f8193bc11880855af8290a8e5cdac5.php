<div class="col-md-12  ">
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details form_body" id="area__voucher_details">
                                            ...
                                            ?>
                                              <?php if($data->_ledger_id !=$_s_acc->_ledger_id): ?>
                                            <tr class="_voucher_row">
                                              <td>
                                                <a  href="#none" class="btn btn-sm btn-default _voucher_row_remove" ><i class="fa fa-trash"></i></a>
                                              </td>
                                              <td>
                                                <input type="text" name="_search_ledger_id[]" class="form-control _search_ledger_id width_280_px" placeholder="Ledger" value="<?php echo e($_s_acc->_ledger->_name ?? ''); ?>" <?php if($__user->_ac_type==1): ?> attr_account_head_no="1" <?php endif; ?>  > 
                        ...
                        </div><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/sales-return/edit_ac_cb.blade.php ENDPATH**/ ?>