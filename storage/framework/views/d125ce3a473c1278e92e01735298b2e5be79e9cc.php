          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
             ...
             <li class="breadcrumb-item active">
               ...
               href="<?php echo e(route('approval-chain.create')); ?>">
                     ...
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              ...
                              <a  type="button" 
                                  href="<?php echo e(route('approval-chain.show',$data->id)); ?>"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>

                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('approval-chain-edit')): ?>
                                  <a  type="button" 
                                  href="<?php echo e(route('approval-chain.edit',$data->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\solar-acc-invenoty\resources\views/rlp-module/approval-chain/index.blade.php ENDPATH**/ ?>