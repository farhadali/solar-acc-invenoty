        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="<?php echo e(route('purchase-return.store')); ?>" method="POST" class="purchase_form" >
                <?php echo csrf_field(); ?>
                    <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              <label class="mr-2" for="_order_ref_id">Purchase Invoice Number:<span class="_required">*</span></label>
                              <input type="text" id="_search_order_ref_id" name="_search_order_ref_id" class="form-control _search_order_ref_id" value="<?php echo e(old('_order_ref_id')); ?>" placeholder="Purchase Invoice Number" >
                              <input type="hidden" id="_order_ref_id" name="_order_ref_id" class="form-control _order_ref_id" value="<?php echo e(old('_order_ref_id')); ?>" placeholder="Purchase Invoice Number" >
                      ...
                      <?php echo $__env->make('backend.purchase-return.create_ac_cb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                         
                      <?php else: ?>
                       <?php echo $__env->make('backend.purchase-return.create_ac_detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                      <?php endif; ?>
    ...
    //  console.log(unit_conversion_options)
            ...
            $(document).find("#area__purchase_details").append(`<tr class="_purchase_row">
                                              ...
                                              <input type="hidden" class="_old_barcode" value="${((data[i]._barcode=='null') ? '' : data[i]._barcode) }" />
                                                <input type="text" name="${_item_row_count}__barcode__${data[i]._item_id}" class="form-control _barcode _barcode__${i} ${_item_row_count}__barcode " value="" id="${_item_row_count}__barcode"   >
                                              </td>
                                              <?php else: ?>
                                              <td class="display_none">
                                              <input type="hidden" class="_old_barcode" value="${((data[i]._barcode=='null') ? '' : data[i]._barcode) }" />
...
$(document).find("._transection_unit___"+i).val(data[i]?._base_unit_id);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/purchase-return/create.blade.php ENDPATH**/ ?>