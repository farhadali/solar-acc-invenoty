        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('report-shortage-item')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    <div class="row">
                         ...
                         <select class="form-control width_150_px _cost_center multiple_select" multiple name="_cost_center[]" size='2'  >
                            ...
                            <option value="<?php echo e($costcenter->id); ?>" 
                              ...
                              <?php if(in_array($costcenter->id,$previous_filter["_cost_center"])): ?> selected <?php endif; ?>
                                 <?php endif; ?>
                              > <?php echo e($_category->_parents->_name ?? ''); ?>/<?php echo e($costcenter->_name ?? ''); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <?php endif; ?>
                          </select>
                      </div>
                  <?php endif; ?>
                        ...
                        <select class="form-control width_150_px _item_category multiple_select" multiple name="_item_category[]" size='6'  >
                            ...
                            <option value="<?php echo e($_category->id); ?>" 
                              ...
                              <?php if(in_array($_category->id,$previous_filter["_item_category"])): ?> selected <?php endif; ?>
                                 <?php endif; ?>
                              > <?php echo e($_category->_name ?? ''); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <?php endif; ?>
                          </select>
                    ...
                    <div class="row">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="<?php echo e(url('reset-expired-item')); ?>" class="btn btn-danger form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                        </div>
                        <br><br>
                     </div>
                    <?php echo Form::close(); ?>
...
$(document).find('._item_category').on('change',function(){
    ...
    function _category_base_items(_category_id){
      var request = $.ajax({
          url: "<?php echo e(url('shortage-item-cat-item')); ?>",
          method: "GET",
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/inventory-report/filter_shortage_item.blade.php ENDPATH**/ ?>