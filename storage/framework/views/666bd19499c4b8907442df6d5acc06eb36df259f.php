          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
                 <a target="__blank" href="<?php echo e(url('damage/print')); ?>/<?php echo e($data->id); ?>" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
             ...
             <li class="breadcrumb-item ">
              ...
              <li class="breadcrumb-item ">
                        <a title="Add New" class="btn btn-success btn-sm" href="<?php echo e(route('damage.create')); ?>"> <i class="nav-icon fas fa-plus"></i> </a>
               </li>
              <?php endif; ?>
              <li class="breadcrumb-item ">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="<?php echo e(url('damage/update')); ?>" method="POST" class="purchase_form" >
                <?php echo csrf_field(); ?>
                      <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_order_number"  name="_order_number"  class="form-control _order_number"  value="<?php echo e(old('_order_number' ,$data->id)); ?>" placeholder="Order Number"  readonly>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 display_none">
                            <div class="form-group">
                              ...
                              <input type="text" id="_order_ref_id" name="_order_ref_id" class="form-control _order_ref_id" value="<?php echo e(old('_order_ref_id',$data->_order_ref_id)); ?>" placeholder="Damage Order" >
       ...
       <?php endif; ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="<?php echo e(old('_search_main_ledger_id',$data->_ledger->_name ?? '' )); ?>" placeholder="Ledger" required>

                            <input type="hidden" id="_main_ledger_id" name="_main_ledger_id" class="form-control _main_ledger_id" value="<?php echo e(old('_main_ledger_id',$data->_ledger_id)); ?>" placeholder="Ledger" required>
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          <thead >
                                            ...
                                            <th class="text-left <?php if($_show_cost_rate == 0): ?> display_none <?php endif; ?>" >Cost Rate</th>
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            ...
                                            <tr class="_purchase_row">
                                              ...
                                              <td>
                                                <input type="text" name="_search_item_id[]" class="form-control _search_item_id width_280_px" placeholder="Item" value="<?php echo e($detail->_purchase_invoice_no ?? ''); ?>,<?php echo e($detail->_items->_name ?? ''); ?>, <?php echo e($detail->_items->_qty ?? ''); ?>">
                                                ...
                                                <input type="hidden" name="_purchase_detail_id[]" class="form-control _purchase_detail_id" value="<?php echo e($detail->_purchase_detail_id); ?>" >
                                                <input type="hidden" name="_sales_detail_row_id[]" class="form-control _sales_detail_row_id" value="<?php echo e($detail->id); ?>" >
                                              ...
                                              <td class="<?php if($_show_barcode == 0): ?> display_none <?php endif; ?>">
                                                ...
                                                <input type="hidden" name="_unique_barcode[]" value="<?php echo e($detail->_items->_unique_barcode); ?>" class="_unique_barcode   1__unique_barcode" id="<?php echo e(($m_key+1)); ?>_unique_barcode">
      ...
      showPlusAfter: 1,
                                            ...
                                            <?php endif; ?>
                                              <td class="<?php if($_show_warranty  ==0): ?> display_none <?php endif; ?>">
                                                <select name="_warranty[]" class="form-control _warranty <?php echo e(($m_key+1)); ?>___warranty">
                                              ...
                                              <td>
                                                <input type="number" min="0"  name="_qty[]" class="form-control _qty _common_keyup"  value="<?php echo e($detail->_qty ?? 0); ?>"  <?php if($detail->_items->_unique_barcode==1): ?> readonly <?php endif; ?> >
                                              </td>
                                              <td class="<?php if($_show_cost_rate == 0): ?> display_none <?php endif; ?>">
                                                <input type="number" min="0"  name="_rate[]" class="form-control _rate  " value="<?php echo e($detail->_rate ?? 0); ?>" readonly>
                                              </td>
                                              <td>
                                                <input type="number" min="0"  name="_sales_rate[]" class="form-control _sales_rate " value="<?php echo e($detail->_sales_rate ?? 0); ?>" >
                                              </td>
                                             
                                              <td class="<?php if($_show_vat == 0): ?> display_none <?php endif; ?>">
                                                <input type="number" name="_vat[]" class="form-control  _vat _common_keyup" value="<?php echo e($detail->_vat ?? 0); ?>">
                                              </td>
                                              <td class="<?php if($_show_vat == 0): ?> display_none <?php endif; ?>">
                                                <input type="number" name="_vat_amount[]" class="form-control  _vat_amount" value="<?php echo e($detail->_vat_amount ?? 0); ?>" >
                                              </td>
                                              ...
                                              <td>
                                                <input type="number" min="0"  name="_value[]" class="form-control _value " readonly value="<?php echo e($detail->_value ?? 0); ?>" >
                                              </td>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          ...
                          <input type="hidden" name="_item_row_count" value="<?php echo e(sizeof($___master_details)); ?>" class="_item_row_count">
                              </td>
                            </tr>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="<?php echo e(url('sales-settings')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<script type="text/javascript">
 ...
 $(document).on("click","#form_settings",function(){
  ...
  var request = $.ajax({
      url: "<?php echo e(url('item-damage-search-edit')); ?>",
      method: "GET",
 ...
 var single_row =  `<tr class="_voucher_row">
                      ...
                      <select class="form-control width_150_px _branch_id_detail" name="_branch_id_detail[]"  required >
                        ...
                        <?php endif; ?>
                            ...
                            <td>
                              <input type="number" min="0"  name="_dr_amount[]" class="form-control  _dr_amount" placeholder="Dr. Amount" value="<?php echo e(old('_dr_amount',0)); ?>">
                            </td>
                            <td>
                              <input type="number" min="0"  name="_cr_amount[]" class="form-control  _cr_amount" placeholder="Cr. Amount" value="<?php echo e(old('_cr_amount',0)); ?>">
                              </td>
                            </tr>`;
 ...
 $(document).on('click','._purchase_row_remove',function(event){
  ...
  $(document).on('click','.submit-button',function(event){
    ...
    if(_p_p_l_ids_qtys.length > 0){
        var request = $.ajax({
                url: "<?php echo e(url('check-available-qty-update-damage')); ?>",
                method: "GET",
                async:false,
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/damage/edit.blade.php ENDPATH**/ ?>