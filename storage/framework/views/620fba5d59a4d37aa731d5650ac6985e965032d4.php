...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1 class="m-0 _page_name"><a  href="<?php echo e(route('inter-project-voucher.index')); ?>"> <?php echo $page_name ?? ''; ?> </a>  
                             ...
                             <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item " href="<?php echo e(route('inter-project-voucher.show',$data->id)); ?>">
                                        View
                                      </a>
                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inter-project-voucher-edit')): ?>
                                        <a class="dropdown-item " href="<?php echo e(route('inter-project-voucher.edit',$data->id)); ?>">
                                         Edit
                                        </a>
                                    <?php endif; ?>
                                    <?php
                                    ...
                                    <?php endif; ?>
                                     ...
                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inter-project-voucher-delete')): ?>
                                    <?php echo Form::open(['method' => 'DELETE','route' => ['inter-project-voucher.destroy', $data->id],'style'=>'display:inline']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/inter-project-voucher/index.blade.php ENDPATH**/ ?>