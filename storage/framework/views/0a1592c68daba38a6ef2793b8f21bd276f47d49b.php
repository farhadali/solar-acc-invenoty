...
<div class="content-header">
    ...
    ?>
              <div class="card-body">
               <form action="<?php echo e(route('material-issue-return.store')); ?>" method="POST" class="purchase_form" >
                <?php echo csrf_field(); ?>
                    <div class="row">
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_search_order_ref_id" name="_search_order_ref_id" class="form-control _search_order_ref_id" value="<?php echo e(old('_order_ref_id')); ?>" placeholder="<?php echo e(__('label.issue_number')); ?>" >
                              <input type="hidden" id="_order_ref_id" name="_order_ref_id" class="form-control _order_ref_id" value="<?php echo e(old('_order_ref_id')); ?>" placeholder="<?php echo e(__('label.issue_number')); ?>" >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                         <div class="form-group ">
                            ...
                            <select class="form-control _master_organization_id" name="organization_id" required >
                               ...
                               <option value="<?php echo e($val->id); ?>" disabled><?php echo e($val->id ?? ''); ?> - <?php echo e($val->_name ?? ''); ?></option>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                         <div class="form-group ">
                            ...
                            <select class="form-control _master_branch_id" name="_branch_id" required >
                               ...
                               <option value="<?php echo e($branch->id); ?>" disabled ><?php echo e($branch->id ?? ''); ?> - <?php echo e($branch->_name ?? ''); ?></option>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                               <?php endif; ?>
                             </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                         <div class="form-group ">
                            ...
                            <select class="form-control _cost_center_id" name="_cost_center_id" required >
                               ...
                               <option value="<?php echo e($cost_center->id); ?>" disabled><?php echo e($cost_center->_code ?? ''); ?> - <?php echo e($cost_center->_name ?? ''); ?></option>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                               <?php endif; ?>
                             </select>
                         </div>
            ...
            <div class="row">
                         <div class="col-xs-12 col-sm-12 col-md-3 ">
                            ...
                            <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="<?php echo e(old('_search_main_ledger_id')); ?>" placeholder="<?php echo e(__('label._ledger_id')); ?>" required readonly>

                            <input type="hidden" id="_main_ledger_id" name="_main_ledger_id" class="form-control _main_ledger_id" value="<?php echo e(old('_main_ledger_id')); ?>" placeholder="<?php echo e(__('label._ledger_id')); ?>" required>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_phone" name="_phone" class="form-control _phone" value="<?php echo e(old('_phone')); ?>" placeholder="<?php echo e(__('label._phone')); ?>" >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_address" name="_address" class="form-control _address" value="<?php echo e(old('_address')); ?>" placeholder="<?php echo e(__('label._address')); ?>" >
                              ...
                              <td style="border:0px;width: 80%;">
                                <?php if($_print = Session::get('_print_value')): ?>
                                    ...
                                    <?php if($_master_id = Session::get('_master_id')): ?>
                                     <input type="hidden" name="_master_id" value="<?php echo e(url('sales-return/print')); ?>/<?php echo e($_master_id); ?>" class="_master_id">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="<?php echo e(url('material-issue-settings')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<script type="text/javascript">
  ...
  var request = $.ajax({
      url: "<?php echo e(url('material-issue-search')); ?>",
      method: "GET",
...
console.log(result)
      ...
      if(data.length > 0 ){
            search_html +=`<div class="card"><table table-bordered style="width: 100%;">
                            <thead>
                              <th style="border:1px solid #ccc;text-align:center;"><?php echo e(__('label.id')); ?></th>
                              <th style="border:1px solid #ccc;text-align:center;"><?php echo e(__('label.issue_number')); ?></th>
                              <th style="border:1px solid #ccc;text-align:center;"><?php echo e(__('label._ledger_id')); ?></th>
                              <th style="border:1px solid #ccc;text-align:center;"><?php echo e(__('label._date')); ?></th>
                            </thead>
                            <tbody>`;
...
$(document).on("click",'.search_row_purchase_order',function(){
    ...
    var _material_issue_order_number = $(this).find('._material_issue_order_number').val();
...
$(document).find("._assign_cost_center_id").val(__cost_center_id);
    ...
    $("._search_order_ref_id").val(_material_issue_order_number);

    $.ajaxSetup({ headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') } });

    var request = $.ajax({
      url: "<?php echo e(url('material-issue-details')); ?>",
      method: "POST",
...
if(data.length > 0 ){
  for (var i = 0; i < data.length; i++) {
     var _row_id = (data[i].id) ? data[i].id : '' ;
 ...
 $(document).on('click','._purchase_row_remove',function(event){
  ...
  $(document).on('click','.submit-button',function(event){
    ...
    if(_p_p_l_ids_qtys.length > 0){
        var request = $.ajax({
                url: "<?php echo e(url('check-sales-return-available-qty')); ?>",
                method: "GET",
                async:false,
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/material-issue-return/create.blade.php ENDPATH**/ ?>