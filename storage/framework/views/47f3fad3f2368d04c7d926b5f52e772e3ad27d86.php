  ...
  <div class="content ">
    ...
    <?php echo $__env->make('backend.message.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="card-body p-4" >
               <?php echo Form::model($data, ['method' => 'PATCH','route' => ['hrm-department.update', $data->id]]); ?>

                <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label><?php echo e(__('label._department')); ?>:<span class="_required">*</span></label>
                                <input class="form-control" type="text" name="_department" placeholder="<?php echo e(__('label._department')); ?>" value="<?php echo e(old('_department',$data->_department ?? '' )); ?>" required>
                            </div>
                        </div>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="_details" placeholder="<?php echo e(__('label._details')); ?>" value="<?php echo e(old('_details',$data->_details ?? '' )); ?>">
                            </div>
                        </div>
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/hrm/hrm-department/edit.blade.php ENDPATH**/ ?>