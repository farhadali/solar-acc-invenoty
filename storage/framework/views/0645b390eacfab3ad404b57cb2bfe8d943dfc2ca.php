        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form target="__blank" action="<?php echo e(url('barcode-print-store')); ?>" method="POST" class="purchase_form" >
                <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-12  ">
                             <div class="card">
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            ...
                                            ?>
                                            <?php $__empty_1 = true; $__currentLoopData = $_master_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php
                                            //dump($val);
                                            ?>
                                            <tr class="_purchase_row _purchase_row__">
                                              ...
                                              <td>
                                                <input type="text" name="_search_item_id[]" class="form-control _search_item_id width_280_px" placeholder="Item" value="<?php echo $val->_items->_name ?? ''; ?>">

                                                <input type="hidden" name="_item_id[]" class="form-control _item_id " value="<?php echo e($val->_item_id); ?>">
                                                <input type="hidden" name="_p_p_l_id[]" class="form-control _p_p_l_id " value="<?php echo e($val->_lot_product->id ?? 0); ?>" >
                                              ...
                                              <td class=" ">
                                                ...
                                                <input type="text" name="_barcode[]" class="form-control _barcode "  value="<?php echo e($val->_barcode ?? ''); ?>"   >
                                                
                                              </td>
                                              
                                              
                                              <td>
                                                <input type="number" name="_qty[]" class="form-control _qty _common_keyup" value="<?php echo e($val->_qty ?? 0); ?>">
                                              </td>
                                              <td>
                                                <input type="number" name="_sales_rate[]" class="form-control _sales_rate _common_keyup " value="<?php echo e($val->_sales_rate ?? 0); ?>">
                                              </td>
                                              
                                              <td class="  ">
                                                <input type="number" name="_vat[]" class="form-control  _vat _common_keyup" placeholder="VAT%" value="<?php echo e($val->_vat ?? 0); ?>">
                                              </td>
                                              <td class=" " >
                                                <input type="number" name="_discount[]" class="form-control  _discount _common_keyup" value="<?php echo e($val->_discount ?? 0); ?>" >
                                              </td>
                                              <td class=" " >
                                                <input type="date" name="_manufacture_date[]" class="form-control  _discount " value="<?php echo e($val->_manufacture_date ?? ''); ?>" >
                                              </td>
                                              <td class=" " >
                                                <input type="date" name="_expire_date[]" class="form-control  _expire_date " value="<?php echo e($val->_expire_date ?? ''); ?>" >
                                              </td>
                                            </tr>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/item-information/label-print.blade.php ENDPATH**/ ?>