          ...
          <tbody>
           ...
           ?>
                   ...
                   <?php $__empty_3 = true; $__currentLoopData = $l2value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l_3key=>$l3value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_3 = false; ?>
                     ...
                     ?>
                     <?php if($previous_filter["_level"] !="Level 1"): ?>
                          <tr>
                   ...
                   <tr>
                     <td style="text-align: left;">&nbsp; &nbsp; <?php echo $l_3key; ?></td>
                     <td style="text-align: right;padding-right: 10px;"> <?php echo _show_amount_dr_cr(_report_amount(  $summary_l3 )); ?></td>
                   </tr>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/account-report/balance_sheet_level_1.blade.php ENDPATH**/ ?>