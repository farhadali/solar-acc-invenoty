                ...
                <?php echo csrf_field(); ?>
                    <div class="row">
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              <label class="mr-2" for="_is_direct_sales"><?php echo e(__('label._is_direct_sales')); ?>:</label>
                              <select id="_is_direct_sales" class="form-control _is_direct_sales" name="_is_direct_sales">
                                <option value="0"><?php echo e(__('label._store_sales')); ?></option>
                                <option value="1"><?php echo e(__('label._direct_sales')); ?></option>
                              </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_direct_purchase_no" name="_direct_purchase_no" class="form-control _direct_purchase_no" value="<?php echo e(old('_direct_purchase_no')); ?>" placeholder="<?php echo e(__('label._direct_purchase_no')); ?>"  readonly>
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-3 ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <textarea id="_delivery_details" name="_delivery_details" class="form-control _delivery_details" value="<?php echo e(old('_delivery_details','')); ?>" placeholder="<?php echo e(__('label._delivery_details')); ?>"><?php echo e(old('_delivery_details')); ?></textarea>
                    ...
                    ?>
                        <div class="col-xs-12 col-sm-12 col-md-3   <?php if($_show_vn==0): ?> display_none <?php endif; ?>">
                            <div class="form-group">
                              ...
                              <select class="form-control _vessel_no" name="_vessel_no">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;margin: 0px auto;">
                            ...
                            <tr>
                              ...
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_sd_input" class="form-control width_200_px" id="_sd_input" value="0" >
                              </td>
                            </tr>
                            <tr>
                              <td style="border:0px;width: 20%;"><label for="total_sd_amount">Total SD</label></td>
                              <td style="border:0px;width: 80%;">
                                <input type="number" name="total_sd_amount" class="form-control width_200_px" id="total_sd_amount" readonly value="0">
                              </td>
                            </tr>
 ...
 //console.log("this row id "+row_id)
  ...
  //First check added this row is available yes or not if yes then increase the item qty amount or create new row
      ...
      if(_has_item_row ==true){
        ...
        _add_new_row_for_barcode(_warranty,row_id,_name,_p_item_item_id,_unit_id,_barcode,_manufacture_date,_expire_date,_sales_rate,_qty,_pur_rate,_sales_discount,_sales_vat,_purchase_detail_id,_master_id,_branch_id,_cost_center_id,_store_id,_store_salves_id,_sales_vat,_discount_amount,_vat_amount,_value,_sd,_sd_amount);
        _purchase_total_calculation();
      }
}
...
function _add_new_row_for_barcode(_warranty,row_id,_name,_p_item_item_id,_unit_id,_barcode,_manufacture_date,_expire_date,_sales_rate,_qty,_pur_rate,_sales_discount,_sales_vat,_purchase_detail_id,_master_id,_branch_id,_cost_center_id,_store_id,_store_salves_id,_discount_amount,_vat_amount,_value,_sd,_sd_amount){
...
var _search_item_id="_search_item_id__"+row_id;
  ...
  $(this).parent().parent().parent().parent().parent().parent().find('._main_store_id').val(_store_id).change();
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/sales/create.blade.php ENDPATH**/ ?>