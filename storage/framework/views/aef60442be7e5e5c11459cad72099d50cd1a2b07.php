                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_direct_purchase_no" name="_direct_purchase_no" class="form-control _direct_purchase_no" value="<?php echo e(old('_direct_purchase_no')); ?>" placeholder="<?php echo e(__('label._direct_purchase_no')); ?>"  >
