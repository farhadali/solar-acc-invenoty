        ...
        <tbody>
         ...
         <?php
                                  ...
                                  <tr>
                                     ...
                                     ?>
                                             <td class="  " style="word-break: break-all;vertical-align: text-top;border:1px solid silver;" ><?php echo $_item->_items->_name ?? ''; ?><br>
                                             ...
                                             <td class="text-left  " style="vertical-align: text-top;border:1px solid silver;"><?php echo $_item->_trans_unit->_name ?? ''; ?></td>
                                            
                                             <td class="text-right  " style="vertical-align: text-top;border:1px solid silver;"><?php echo _report_amount($_item->_qty ?? 0); ?></td>
                                            <td class="text-right  " style="vertical-align: text-top;border:1px solid silver;"><?php echo _report_amount($_item->_sales_rate ?? 0); ?></td>
                                            
                                            <td class="text-right  " style="vertical-align: text-top;border:1px solid silver;"><?php echo _report_amount($_item->_value ?? 0); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/sales/print_1.blade.php ENDPATH**/ ?>