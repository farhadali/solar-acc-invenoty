...
<form method="POST" action="<?php echo route('login'); ?>">
 ...
 <?php echo $__env->make('backend.message.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <div class="container">
    ...
    <input type="text" placeholder="Enter email/ User name" name="email" required value="<?php echo old('email'); ?>">
...
<?php /**PATH D:\xampp\htdocs\solar-acc-invenoty\resources\views/auth/login.blade.php ENDPATH**/ ?>