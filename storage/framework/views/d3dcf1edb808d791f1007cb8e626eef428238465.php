        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('report-item-history')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                     ...
                     <div class="row">
                         ...
                         <table class="table table-bordered" style="width: 100%;">
                           <tr>
                             <td>
                               <input type="text" name="_search_item_id" class="form-control _search_item_id width_280_px" placeholder="Item" value="<?php echo e($previous_filter["_search_item_id"] ?? ''); ?>">
                                                <input type="hidden" name="_item_id" class="form-control _item_id width_200_px" value="<?php echo e($previous_filter["_item_id"] ?? ''); ?>">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="<?php echo e(url('reset-item-history')); ?>" class="btn btn-danger form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                        </div>
                        <br><br>
                     </div>
                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/inventory-report/filter_item_history.blade.php ENDPATH**/ ?>