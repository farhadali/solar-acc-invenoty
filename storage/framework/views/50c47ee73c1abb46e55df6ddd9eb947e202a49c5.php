              ...
              <div class="modal-content">
                ...
                <div class="modal-body search_modal">
                 <?php 
                  ...
                  <div class="form-group row">
                    <label for="id" class="col-sm-2 col-form-label">Invoice NO:</label>
                    <div class="col-sm-10">
                          ...
                          <div class="col-md-8">
                              <div class="form-group ">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="<?php echo e(url('restaurant-sales-reset')); ?>" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
                   
                  </form>
                </div><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/backend/restaurant-sales/search.blade.php ENDPATH**/ ?>