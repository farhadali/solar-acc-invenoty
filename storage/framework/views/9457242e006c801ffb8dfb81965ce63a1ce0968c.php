      ...
      <li class="nav-item dropdown remove_from_header">
        <a class="nav-link" data-toggle="dropdown" href="#">
           <?php echo e(__('label.pm_module')); ?> <i class="right fas fa-angle-down"></i>
        </a>
    ...
    <?php endif; ?><?php /**PATH D:\xampp\htdocs\solar-acc-invenoty\resources\views/backend/layouts/pm_module.blade.php ENDPATH**/ ?>