...
<div class="_report_button_header">
    <a class="nav-link"  href="<?php echo e(url('rlp-chain')); ?>" role="button"><i class="fa fa-arrow-left"></i></a>
 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rlp-chain-edit')): ?>
 <a  href="<?php echo e(route('rlp-chain.edit',$data->id)); ?>" 
...
<section class="invoice" id="printablediv">
    ...
    <table class="table" style="width:100%;">
      <tr>
            ...
            <b><?php echo e(__('label.rlp-chain')); ?></b>
                </td>
              </tr>
      <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/rlp-module/rlp-chain/show.blade.php ENDPATH**/ ?>