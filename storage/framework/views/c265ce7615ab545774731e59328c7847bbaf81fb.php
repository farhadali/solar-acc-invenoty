                      ...
                      <tbody>
                        ...
                        <tr>
                             <td style="display: flex;">
                                ...
                                <button  type="button" 
                                  attr_base_edit_url="<?php echo e(route('unit.show',$data->id)); ?>"
                                  data-toggle="modal" 
                                  data-target="#commonEntryModal_item" 
                                  ...
                                  <button  type="button" 
                                  attr_base_edit_url="<?php echo e(route('unit.edit',$data->id)); ?>"
                                  data-toggle="modal" 
                                  data-target="#commonEntryModal_item" 
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/unit/index.blade.php ENDPATH**/ ?>