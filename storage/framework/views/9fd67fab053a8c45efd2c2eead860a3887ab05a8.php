        ...
        <div class="row mb-2">
          <div class=" col-sm-8 ">
            <h1 class="m-0 _page_name">
              <a  href="<?php echo e(route('voucher.index')); ?>"> <?php echo $page_name ?? ''; ?> </a>    
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <?php echo Form::open(array('route' => 'easy-voucher.store','method'=>'POST','class'=>'voucher-form')); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/easy-voucher/create.blade.php ENDPATH**/ ?>