...
<div class="wrapper print_content">
  ...
  <div class="_report_button_header">
    <a class="nav-link"  href="<?php echo e(url('stock-ledger')); ?>" role="button">
...
<section class="invoice" id="printablediv">
   ...
   <table class="cewReportTable">
          ...
          <tbody>
            ...
            <td style="text-transform: capitalize;"><?php echo $g_value->_transection ?? ''; ?> </td>
            <td style="width: 10%;">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/backend/inventory-report/report_stock_ledger.blade.php ENDPATH**/ ?>