...
<div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <select class="form-control col-sm-7" name="_show_sales_rate">
          <option value="0" <?php if(isset($form_settings->_show_sales_rate)): ?><?php if($form_settings->_show_sales_rate==0): ?> selected <?php endif; ?> <?php endif; ?>>NO</option>
          <option value="1" <?php if(isset($form_settings->_show_sales_rate)): ?><?php if($form_settings->_show_sales_rate==1): ?> selected <?php endif; ?> <?php endif; ?>>YES</option>
        </select>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <select class="form-control col-sm-7" name="_show_ard">
          <option value="0" <?php if(isset($form_settings->_show_ard)): ?><?php if($form_settings->_show_ard==0): ?> selected <?php endif; ?> <?php endif; ?>>NO</option>
          <option value="1" <?php if(isset($form_settings->_show_ard)): ?><?php if($form_settings->_show_ard==1): ?> selected <?php endif; ?> <?php endif; ?>>YES</option>
        </select>
      </div>
      <div class="form-group row">
        ...
        <select class="form-control col-sm-7" name="_show_disd">
          <option value="0" <?php if(isset($form_settings->_show_disd)): ?><?php if($form_settings->_show_disd==0): ?> selected <?php endif; ?> <?php endif; ?>>NO</option>
          <option value="1" <?php if(isset($form_settings->_show_disd)): ?><?php if($form_settings->_show_disd==1): ?> selected <?php endif; ?> <?php endif; ?>>YES</option>
        </select>
      </div>
      <div class="form-group row">
...
<br>
      ...
      <script type="text/javascript">
         $('.select2').select2()
      </script><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/transfer/form_setting_modal.blade.php ENDPATH**/ ?>