...
<div class="tab-pane active" id="tab1">
    ...
    <div class="form-group row">
     ...
     <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input class="form-group" type="datetime-local" id="_datetime" name="_datetime" value="<?php echo e(old('_datetime')); ?>" required>
        </div>
</div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/hrm/attandance/create.blade.php ENDPATH**/ ?>