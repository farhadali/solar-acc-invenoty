        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('report-actual-sales')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    <div class="row">
                      <div class="col-md-6">
            ...
            <?php endif; ?> ><?php echo e($group->_name); ?></option>
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="<?php echo e(url('reset-date-wise-sales')); ?>" class="btn btn-danger form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                        </div>
                        <br><br>
                     </div>
                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/inventory-report/filter_actual_sales.blade.php ENDPATH**/ ?>