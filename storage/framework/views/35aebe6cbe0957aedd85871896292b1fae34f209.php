<div  >
    ...
    <div class="modal fade" id="modal-default">
                ...
                <div class="modal-body search_modal">
                 <?php 
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="<?php if(isset($request->_search_main_ledger_id)): ?> <?php echo e($request->_search_main_ledger_id ?? ''); ?>  <?php endif; ?>" placeholder="Ledger" >
                            <input type="hidden" id="_ledger_id" name="_ledger_id" class="form-control _ledger_id" value="<?php if(isset($request->_ledger_id)): ?><?php echo e($request->_ledger_id ?? ''); ?><?php endif; ?>" placeholder="Ledger" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="_search_main_cost_center_id" name="_search_main_cost_center_id" class="form-control _search_main_cost_center_id" value="<?php if(isset($request->_search_main_cost_center_id)): ?> <?php echo e($request->_search_main_cost_center_id ?? ''); ?>  <?php endif; ?>" placeholder="Cost Center" >
                            <input type="hidden" id="_cost_center_id" name="_cost_center_id" class="form-control _cost_center_id" value="<?php if(isset($request->_cost_center_id)): ?><?php echo e($request->_cost_center_id ?? ''); ?><?php endif; ?>" placeholder="Cost Center" required>
        ...
        <!-- /.modal-dialog -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8">
                              <div class="form-group ">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> Filter</button>
                                     <a href="<?php echo e(url('damage-reset')); ?>" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i>  </a>
                ...
                </div><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/damage/search.blade.php ENDPATH**/ ?>