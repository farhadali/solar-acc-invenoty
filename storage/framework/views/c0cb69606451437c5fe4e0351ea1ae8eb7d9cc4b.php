                       ...
                       <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="_manufacture_company" name="_manufacture_company" class="form-control" value="<?php echo e(old('_manufacture_company',$data->_manufacture_company)); ?>" placeholder="Manufacture Company" >
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
...
<?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/item-information/edit.blade.php ENDPATH**/ ?>