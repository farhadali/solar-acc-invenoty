 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventory-menu')): ?> 
      <li class="nav-item dropdown remove_from_header">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <?php echo e(__('label.sales')); ?> <i class="right fas fa-angle-down"></i>
        </a>
    ...
    <?php endif; ?><?php /**PATH D:\xampp\htdocs\solar-acc-invenoty\resources\views/backend/layouts/sales_module.blade.php ENDPATH**/ ?>