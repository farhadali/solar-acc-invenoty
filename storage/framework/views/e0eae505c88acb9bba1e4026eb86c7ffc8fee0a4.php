<?php echo $__env->make('backend.restaurant-pos.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body class="skin-blue layout-top-nav pace-done" style="height: auto;" cz-shortcut-listen="true">
				...
				<div class="container">
					<div class="navbar-header">
						<a href="<?php echo e(url('/home')); ?>" class="logo hidden-xs">
							<!-- mini logo for sidebar mini 50x50 pixels --><span class="logo-mini"><?php echo e($settings->name ?? ''); ?></span>
							<!-- logo for regular state and mobile devices --><span class="logo-lg" style="color: #fff;"> <?php echo e($settings->name ?? ''); ?></span></a>
						<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse"> <i class="fa fa-bars"></i> </button>
					</div>
					<!-- Collect the nav links, forms, and other content for toggling -->
					<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
						<ul class="nav navbar-nav">
							<li class=""><a target="__blank" class="new_invoice_link" href="<?php echo e(url('restaurant-sales')); ?>" title="View Sales List!"><i class="fa fa-list "></i> <span style="font-weight:bold;">Sales List</span></a></li>
							<li class=""><a  href="<?php echo e(url('restaurant-pos')); ?>" title="Create New POS Invoice"><i class="fa fa-calculator  "></i> <span style="font-weight:bold;">New Invoice</span></a></li>
							<li class="">
								<a target="__blank" class="new_invoice_link" href="<?php echo e(url('item-information')); ?>" title="View Items List"><i class="fa  fa-cubes  "></i> <span style="font-weight:bold;">Items List</span>
								</a>
							</li>
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kitchen-list')): ?>
							<li class="">
								<a target="__blank" class="new_invoice_link" href="<?php echo e(url('kitchen')); ?>" title="View Items List"><i class="fa  fa-cubes  "></i> <span style="font-weight:bold;">Kitchen Panel</span>
								</a>
							</li>
          					<?php endif; ?>
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown user user-menu">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-user "></i> <span class="hidden-xs text-bold" ><?php echo e(Auth::user()->name ?? ''); ?></span> </a>
										...
										<div class="pull-left"> 
											<?php if(Auth::user()->ref_id ==0): ?>
									           <a class="dropdown-item text-center btn btn-success" 
									                        href="<?php echo e(url('users')); ?>/<?php echo e(Auth::user()->id); ?>/edit"
									                        >
								...
								<div class="box-header with-border" style="padding-bottom: 3px;">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-4 <?php if(sizeof($permited_branch)==1): ?> display_none <?php endif; ?> " >
											...
											<div class="col-md-4 <?php if(sizeof($store_houses)==1): ?> display_none <?php endif; ?>" >
											...
											<div class="col-xs-12 col-sm-12 col-md-4 <?php if(sizeof($permited_costcenters)==1): ?> display_none <?php endif; ?>"> 
				                                <small>Cost Center:</small><br>
				                                <select  class="form-control _main_cost_center_id " name="_main_cost_center_id" >
				                                   
				                                    <?php $__empty_1 = true; $__currentLoopData = $permited_costcenters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
							                 ...
							                 <div class="col-xs-12 col-sm-12 col-md-2">
				                                ...
				                                <select  class="form-control _sales_spot " name="_sales_spot" >
				                                    ...
				                                    <?php $__empty_1 = true; $__currentLoopData = _sales_spot(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
											...
											<div class="col-md-3" >
												...
												<!-- <select multiple class="form-control _table_id " name="_table_id[]" >
													...
													<option value="<?php echo e($table->id); ?>"><?php echo e($table->_name ?? ''); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
													<?php endif; ?>
												</select> -->
											</div>
											<div class="col-md-3" >
												<small>Delivery Company</small><br/>
												 ...
												 <select  class="form-control delivery_company_id " name="delivery_company_id" >
													...
													<?php $__empty_1 = true; $__currentLoopData = delivery_company(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
													<option value="<?php echo e($key); ?>"><?php echo e($val ?? ''); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
													<?php endif; ?>
												</select> 
											...
											<div class="col-md-3" >
												...
												<select  class="form-control _served_by_ids select2" name="_served_by_ids[]" >
													...
													<?php $__empty_1 = true; $__currentLoopData = $_stewards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_steward): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
													<option value="<?php echo e($_steward->id); ?>"><?php echo e($_steward->_name ?? ''); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
													<?php endif; ?>
												</select>
											</div>
										...
										<div class="col-md-12 display_none">
											...
											<div class="col-md-2 display_none" >
												<div class="form-group">
													...
													<div class="col-sm-5">
														<input  type="text" class="form-control text-right" id="other_charges" name="_other_charge" placeholder="0.00" value=""> <span id="other_charges_msg" style="display:none" class="text-danger"></span> </div>
												</div>
											</div>
											<div class="col-md-12" >
												<div class="form-group">
											...
											<div class="col-md-2 display_none" >
												<div class="form-group">
													...
													<div class="col-sm-5">
														<input  type="text" class="form-control text-right" id="_delivery_charge" name="_delivery_charge" placeholder="0.00" value=""> <span id="_delivery_charge_msg" style="display:none" class="text-danger"></span> </div>
												</div>
											</div>
											<div class="col-md-12" >
												<div class="form-group">
    ...
    padding-bottom: 5px;">
											...
											<div class="col-sm-2 text-left"  >
												...
												<a target="__blank" class="btn bg-danger btn-block btn-flat btn-lg " href="<?php echo e(url('kitchen')); ?>" title="View Items List"><i class="fa  fa-cubes  "></i> <span style="font-weight:bold;">Kitchen </span>
												</a>
				          					   <?php endif; ?>
											...
											<div class="col-sm-2 " >
												<a target="__blank" class="btn bg-danger btn-block btn-flat btn-lg " href="<?php echo e(url('home')); ?>" title="Dashboard"><i class="fa  fa-list  "></i> <span style="font-weight:bold;">Dashboard </span>
												</a>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<select class="form-control select2 select2-hidden-accessible" id="category_id" name="category_id" style="width: 100%;" tabindex="-1" aria-hidden="true">
											...
											<option value="<?php echo e($category->id); ?>"><?php echo e($category->_name ?? ''); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
											<?php endif; ?>
										</select>
									</div>
									...
									<div class="col-md-4" >
										...
										<div class="category_area row" style="border-right: 2px solid #fff;border-left: 2px solid #fff;margin-top: 2px;overflow-y: scroll;min-height: 100px;height: 84vh;">
											...
											?>
												<?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
												<div class="col-md-12 " >
													<div style="font-size: 22px;font-weight: bold;color: #fff;background: <?php echo e($colorHexLighter[rand(1,5)]); ?>"  class="sub_category _single_item_area _single_item_area__<?php echo e($category->id); ?>"
													
															attr_cat_id= "<?php echo e($category->id); ?>"
															title="<?php echo e($category->_name ?? ''); ?>">
															<b><?php echo e($category->_name ?? ''); ?></b>
													</div>
												</div>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
												<?php endif; ?>
					...
					<div class="modal-dialog ">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								?>
								<?php $__empty_1 = true; $__currentLoopData = $vat_rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
								<option data-tax="<?php echo e($vat->_rate); ?>" data-tax-value="<?php echo e($vat->_rate); ?>" 
									value="<?php echo e($vat->_rate); ?>"><?php echo e($vat->_rate); ?></option>
		...
		<!-- Notification sound -->
		<audio id="failed">
			<source src="<?php echo e(asset('backend/pos-template/failed.mp3')); ?>" type="audio/mpeg">
			<source src="<?php echo e(asset('backend/pos-template/failed.ogg')); ?>" type="audio/ogg"> </audio>
		<audio id="success">
			<source src="<?php echo e(asset('backend/pos-template/success.mp3')); ?>" type="audio/mpeg">
			<source src="<?php echo e(asset('backend/pos-template/success.ogg')); ?>" type="audio/ogg"> </audio>
		<script type="text/javascript">
		var failed_sound = document.getElementById("failed");
		var success_sound = document.getElementById("success");
		</script>
		<script src="<?php echo e(asset('backend/pos-template/js/bootstrap.min.js')); ?>"></script>
		<!-- AdminLTE App -->
		<script>
		var AdminLTEOptions = {
		...
		<script src="<?php echo e(asset('backend/pos-template/js/app.js')); ?>"></script>
		<!-- FastClick -->
		<script src="<?php echo e(asset('backend/pos-template/js/fastclick.js')); ?>"></script>
		<!-- Select2 -->
		<script src="<?php echo e(asset('backend/pos-template/js/select2.full.min.js')); ?>"></script>
		<!-- AdminLTE for demo purposes -->
		<script src="<?php echo e(asset('backend/pos-template/js/demo.js')); ?>"></script>
		<!--Toastr notification -->
		<script src="<?php echo e(asset('backend/pos-template/js/toastr.js')); ?>"></script>
		<script src="<?php echo e(asset('backend/pos-template/js/toastr_custom.js')); ?>"></script>
		<!-- bootstrap datepicker -->
		<script src="<?php echo e(asset('backend/pos-template/js/moment.min.js')); ?>"></script>
		<script src="<?php echo e(asset('backend/pos-template/js/daterangepicker.js')); ?>"></script>
		<!-- bootstrap datepicker -->
		<script src="<?php echo e(asset('backend/pos-template/js/bootstrap-datepicker.js')); ?>"></script>
		<!-- Sweet alert -->
		<script src="<?php echo e(asset('backend/pos-template/js/sweetalert.min.js')); ?>"></script>
		<!-- Custom JS -->
		<script src="<?php echo e(asset('backend/pos-template/js/special_char_check.js')); ?>"></script>
		<!-- sweet alert -->
		<script src="<?php echo e(asset('backend/pos-template/js/sweetalert.min.js')); ?>"></script>
		<!-- Autocomplete -->
		<script src="<?php echo e(asset('backend/pos-template/js/autocomplete.js')); ?>"></script>
		<!-- Pace Loader -->
		<script src="<?php echo e(asset('backend/pos-template/js/pace.min.js')); ?>"></script>
		<!-- iCheck -->
		<script src="<?php echo e(asset('backend/pos-template/js/icheck.min.js')); ?>"></script>
		<script>
...
<script type="text/javascript">
		...
		<script src="<?php echo e(asset('backend/pos-template/js/fullscreen.js')); ?>"></script>
		<script src="<?php echo e(asset('backend/pos-template/js/modals.js')); ?>"></script>
		<script>
		...
		function _book_table_list_ajax(){
			$.ajax({
				type: "GET",
				url: "<?php echo e(url('book_table_list_ajax')); ?>",
				async: false,
		...
		$(document).on("click",".recent_invoice_list",function(){
			...
			$.ajax({
				type: "GET",
				url: "<?php echo e(url('recent-restaurnt-sales-list')); ?>",
				data: {
					branch_id,
					store_id,
					_cost_center_id,
				...
				success: function(response) {
					...
					if(data.length > 0){
						for (var i = 0; i < data.length; i++) {
										...
										<div class="col-md-4">
											<div class="card" style="text-align: center;
												...
												<div class="card-body">
													...
													<a class="btn btn-sm btn-danger"  target="__blank" href="<?php echo e(url('restaurant-sales/print')); ?>/${data[i].id}">Print</a>| 
													<button  class="btn btn-sm btn-info" onclick="hold_invoice_edit(${data[i].id})">Edit</button>|
													<a  class="btn btn-sm btn-warning"  target="__blank" href="<?php echo e(url('kitchen-slip')); ?>/${data[i].id}" > Kitchen Slip</a>
													</div>
							...
							// _data_tr +=`<tr>
							// 	<td>${(i+1)}</td>
							// 	<td style="display:flex;"><a class="btn btn-sm btn-danger"  target="__blank" href="<?php echo e(url('restaurant-sales/print')); ?>/${data[i].id}">Print</a>| 
							// 	<button  class="btn btn-sm btn-info" onclick="hold_invoice_edit(${data[i].id})">Edit</button>| 
							// 	<a  class="btn btn-sm btn-warning"  target="__blank" href="<?php echo e(url('kitchen-slip')); ?>/${data[i].id}" > Kitchen Slip</a>
							// 	</td>
		...
		function doneTyping() {
			...
			$.ajax({
				type: "GET",
				url: "<?php echo e(url('item-restaurant-sales-barcode-search')); ?>",
				data: {
        ...
        $.ajax({
           type: "POST",
				url: "<?php echo e(url('restaurant-category-wise-item')); ?>",
				data: {
	...
	$(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
		if(order_id !=""){
				$.ajax({
					type: "GET",
					url: "<?php echo e(url('restaurant-edit')); ?>",
...
$('#hold_invoice').click(function (e) {
	...
	save(print=false,pay_all=false,reference_id,_f_status="sales");
		...
		function save(print = false, pay_all = false, _reference = "N/A", _f_status = "sales") {
			...
			var request = $.ajax({
				 	type: 'POST',
					url: "<?php echo e(url('pos-restaurant-sales-save')); ?>",
					data: data,
					cache: false,
					contentType: false,
					processData: false,
...
<div class="ewMessageDialog"></div><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/backend/restaurant-pos/pos.blade.php ENDPATH**/ ?>