          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <?php echo Form::model($data, ['method' => 'PATCH','route' => ['vessel-info.update', $data->id]]); ?> 
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/vessel-info/edit.blade.php ENDPATH**/ ?>