      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            <a class="m-0 _page_name" href="<?php echo e(route('hrm-emp-location.index')); ?>"><?php echo $page_name ?? ''; ?> </a>
            <ol class="breadcrumb float-sm-right ml-2">
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('hrm-emp-location-create')): ?>
             <li class="breadcrumb-item active">
                <a type="button" 
               class="btn btn-sm btn-info" 
              
               href="<?php echo e(route('hrm-emp-location.create')); ?>">
                     ...
                     <tbody>
                        ...
                        <tr>
                             <td style="display: flex;">
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('hrm-emp-location-delete')): ?>
                                 <?php echo Form::open(['method' => 'DELETE','route' => ['hrm-emp-location.destroy', $data->id],'style'=>'display:inline']); ?>
                               ...
                               <?php endif; ?> 
                              <a  type="button" 
                                  href="<?php echo e(route('hrm-emp-location.show',$data->id)); ?>"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>

                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('hrm-emp-location-edit')): ?>
                                  <a  type="button" 
                                  href="<?php echo e(route('hrm-emp-location.edit',$data->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/hrm/hrm-emp-location/index.blade.php ENDPATH**/ ?>