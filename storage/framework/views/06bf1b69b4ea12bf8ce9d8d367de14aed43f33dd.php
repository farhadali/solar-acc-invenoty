 <div class="col-md-12  ">
                                          ...
                                          <tbody class="area__voucher_details form_body" id="area__voucher_details">
                                            <tr class="_voucher_row">
                                              ...
                                              <td>
                                                ...
                                                <input type="hidden" name="_ledger_id[]" class="form-control _ledger_id" <?php if($__user->_ac_type==1): ?> attr_account_head_no="1" <?php endif; ?>  >
                        ...
                        </div><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/sales-return/create_ac_cb.blade.php ENDPATH**/ ?>