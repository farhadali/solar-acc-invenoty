...
<body class="skin-blue layout-top-nav pace-done" style="height: auto;" cz-shortcut-listen="true">
				...
				<div class="container">
					<div class="navbar-header">
						<a href="<?php echo e(url('/home')); ?>" class="logo hidden-xs">
							<!-- mini logo for sidebar mini 50x50 pixels --><span class="logo-mini"><img src="<?php echo e(asset('/')); ?><?php echo e($default_image ?? ''); ?>" alt="<?php echo e($settings->name ?? ''); ?>" style="height: 50px; width: 50px;"></span>
							<!-- logo for regular state and mobile devices --><span class="logo-lg" style="color: #fff;"><img src="<?php echo e(asset('/')); ?><?php echo e($default_image ?? ''); ?>" alt="<?php echo e($settings->name ?? ''); ?>" style="height: 50px; width: 50px; -webkit-filter: drop-shadow(0 0 1px #000); filter: drop-shadow(0 0 1px #000);"> <?php echo e($settings->name ?? ''); ?></span></a>
						<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse"> <i class="fa fa-bars"></i> </button>
					</div>
					<!-- Collect the nav links, forms, and other content for toggling -->
					<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
						<ul class="nav navbar-nav">
							<li class=""><a  target="__blank"  class="new_invoice_link" href="<?php echo e(url('sales')); ?>" title="View Sales List!"><i class="fa fa-list "></i> <span style="font-weight:bold;">Sales List</span></a></li>
							<li class=""><a  target="__blank"  class="new_invoice_link" href="<?php echo e(url('pos-sales')); ?>" title="Create New POS Invoice"><i class="fa fa-calculator  "></i> <span style="font-weight:bold;">New Invoice</span></a></li>
							<li class=""><a  target="__blank"  class="new_invoice_link" href="<?php echo e(url('item-information')); ?>" title="View Items List"><i class="fa  fa-cubes  "></i> <span style="font-weight:bold;">Items List</span></a></li>
						</ul>
					</div>
					<!-- /.navbar-collapse -->
					<!-- Navbar Right Menu -->
			...
			<div class="col-md-6">
				<div class="">
					...
					<select class="form-control payment_group_change" id="payment_type_1" name="payment_type[]">
						...
						$first_id = 0;
						?>
						<?php $__empty_1 = true; $__currentLoopData = $payment_accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
						<?php
						if($key ===0){
							$first_id = $account->id;
						}
						...
						?>
						<option attr_value="<?php echo e($account->id); ?>" value="<?php echo e($account->id); ?>"><?php echo e($account->_name); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
						<?php endif; ?>
						
						<input type="hidden" class="payment_group" name="payment_group[]" id="payment_group_1" value="<?php echo e($first_id); ?>" /> 
    ...
    border-left: 2px solid #fff;">
										<div class="col-xs-12 ">
											...
											<?php if($general_settings->_sms_service ==1): ?>
											<div class="col-md-4" >
												<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<select class="form-control select2 select2-hidden-accessible" id="category_id" name="category_id" style="width: 100%;" tabindex="-1" aria-hidden="true">
											...
											<?php $__empty_1 = true; $__currentLoopData = $parent_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<script type="text/javascript">
		...
		<!-- <script src="<?php echo e(asset('backend/pos-template/js/mousetrap.min.js')); ?>"></script>
		<script src="<?php echo e(asset('backend/pos-template/js/bootstrap3-typeahead.min.js')); ?>"></script>
		<script src="<?php echo e(asset('backend/pos-template/js/jquery.validate.js')); ?>"></script>
		<script src="<?php echo e(asset('backend/pos-template/js/additional-methods.min.js')); ?>"></script> -->
   ...
   box-shadow: rgba(9, 30, 66, 0.25) 0px 1px 1px, rgba(9, 30, 66, 0.13) 0px 0px 1px 1px;
    padding: 2px;">
													 <span class="label label-success push-right" style="font-weight: bold;font-family: sans-serif;" data-toggle="tooltip" title="${data.available_qty} Quantity in Stock">Qty: ${parseFloat(data.available_qty).toFixed(2)}</span>
														<div class="">
															<center> <img class=" img-responsive item_image" src="<?php echo e(asset('/')); ?><?php echo e($default_image ?? ''); ?>" alt="Item picture"> </center>
        ...
        $.ajax({
           type: "POST",
				url: "<?php echo e(url('category-wise-item')); ?>",
				data: {
...
product_list_html += `<img class=" img-responsive " src="<?php echo e(asset('/')); ?>${_sub_category_list[i]._image}" alt="Item picture" style="width:100%;height:auto;"> `;
															}else{
product_list_html += `<img class=" img-responsive " src="<?php echo e(asset('/')); ?><?php echo e($default_image); ?>" alt="Item picture" style="width:100%;height:auto;"> `;
															}
...
if( data._image !==null ){
			product_list_html += `<img class=" img-responsive item_image"  src="<?php echo e(asset('/')); ?>${data._image}" alt="Item picture">`;
		}else{
		product_list_html += `<img class=" img-responsive item_image"  src="<?php echo e(asset('/')); ?><?php echo e($default_image ?? ''); ?>" alt="Item picture">`;	
		}
					...
					if(_sub_category_list.length ==0 && product_list.length == 0){
					    ...
					    margin-bottom: 5px;"  class="sub_category"
													attr_cat_id= "ALL"
															title="ALL CATEGORY" 
															>
															<img class=" img-responsive " src="<?php echo e(asset('/')); ?><?php echo e($default_image ?? ''); ?>" alt="Item picture" style="width:100%;height:100px;"> 
															<b>ALL CATEGORY</b>
															</div>
      ...
      <span class="swal-icon--warning__dot"></span> </span>
		...
		function save(print = false, pay_all = false, _reference = "N/A", _f_status = "sales") {
			...
			var request = $.ajax({
				 	type: 'POST',
					url: "<?php echo e(url('pos-sales-save')); ?>",
					data: data,
					cache: false,
					contentType: false,
					processData: false,
		...
		$('#add_payment_row').click(function(e) {
			...
			if($(".items_table tr").length == 1) {
				...
				$.post("<?php echo e(url('pos-payment-row')); ?>", {
...
<div class="ewMessageDialog"></div><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/pos/index.blade.php ENDPATH**/ ?>