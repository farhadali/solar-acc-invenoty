   ...
   <div style="width: 100%;margin-bottom: <?php echo e($_margin_bottom); ?>;margin-top: <?php echo e($_margin_top); ?>;margin-left: <?php echo e($_margin_left); ?>;margin-right: <?php echo e($_margin_right); ?>" > 
     ...
     <div class="row">
      ...
      <div class="col-3 ">
       ...
       <table style="width: 100%;" class="_grid_table">
        <thead>
         <tr>
        ...
        <tbody>
         ...
         <?php
                                  ...
                                  <tr>
                                     ...
                                     ?>
                                          <td class="  " style="word-break: break-all;vertical-align: text-top;"><?php echo $_item->_items->_name ?? ''; ?> <br>
                                          ...
                                          <td class="  " style="word-break: break-all;vertical-align: text-top;"><?php echo $_item->_trans_unit->_name ?? ''; ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/sales/print_3.blade.php ENDPATH**/ ?>