...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class=" col-sm-6 ">
            <a class="m-0 _page_name" href="<?php echo e(route('restaurant-sales.index')); ?>"><?php echo $page_name ?? ''; ?> </a>
          </div><!-- /.col -->
          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
               ...
               <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurant-sales-form-settings')): ?>
             <li class="breadcrumb-item ">
              ...
              <?php endif; ?>
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="<?php echo e(route('restaurant-sales.index')); ?>"> <i class="nav-icon fas fa-list"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               <?php endif; ?> -->
               <form action="<?php echo e(route('restaurant-sales.store')); ?>" method="POST" class="purchase_form" >
                <?php echo csrf_field(); ?>
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-4 <?php if(sizeof($permited_branch)==1): ?> display_none <?php endif; ?>">
                            <div class="form-group">
                                <label>Branch:</label>
                                <select  class="form-control _branch_id " name="_branch_id" >
                                   
                                    <?php $__empty_1 = true; $__currentLoopData = $permited_branch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 <?php if(sizeof($store_houses)==1): ?> display_none <?php endif; ?>">
                            <div class="form-group">
                                <label>Store:</label>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select  class="form-control _table_id select2" name="_table_id[]" multiple>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                <label for="_served_by_ids">Steward/Waiter:</label>
                                <select id="_served_by_ids"  class="form-control _served_by_ids select2" name="_served_by_ids[]" multiple>
                                    <?php $__empty_1 = true; $__currentLoopData = $_stewards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ledger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value="<?php echo e($ledger->id); ?>"><?php echo e($ledger->_name ?? ''); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <?php endif; ?>
                                  </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select  class="form-control _delivery_status " name="_delivery_status" >
                                    <?php $__empty_1 = true; $__currentLoopData = _delivery_status(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value="<?php echo e($key); ?>"><?php echo e($val); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <?php endif; ?>
                                  </select>
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        <input type="hidden" name="_form_name" class="_form_name"  value="resturant_sales">
                            <div class="form-group">
                                <label>Date:</label>
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-3 ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_referance" name="_referance" class="form-control _referance" value="<?php echo e(old('_referance','N/A')); ?>" placeholder="Referance" >
                            </div>
                        </div>
                      ...
                      <?php endif; ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;margin: 0px auto;">
                              ...
                              <td style="border:0px;width: 80%;">
                                <?php if($_print = Session::get('_print_value')): ?>
                                    ...
                                    <?php if($_master_id = Session::get('_master_id')): ?>
                                     <input type="hidden" name="_master_id" value="<?php echo e(url('restaurant-sales/print')); ?>/<?php echo e($_master_id); ?>" class="_master_id">
                            ...
                            <tr>
                              <td style="border:0px;width: 20%;"><label for="_service_charge">Service Charge</label></td>
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_service_charge" class="form-control width_200_px" id="_service_charge" value="0" >
                              </td>
                            </tr>
                            <tr>
                              <td style="border:0px;width: 20%;"><label for="_other_charge">Other Charge</label></td>
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_other_charge" class="form-control width_200_px" id="_other_charge" value="0" >
                              </td>
                            </tr>
                            <tr>
                              <td style="border:0px;width: 20%;"><label for="_delivery_charge">Delivery Charge</label></td>
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_delivery_charge" class="form-control width_200_px" id="_delivery_charge" value="0" >
                              </td>
                            </tr>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 bottom_save_section text-middle">
                          <button style="width: 300px;color: red;" type="button" class="btn btn-default  ml-5 ">Net Pay Amount: <b class="__total_payable_amouont">0</b></button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-lg" role="document">
    <form action="<?php echo e(url('restaurant-sales-settings')); ?>" method="POST">
        <?php echo csrf_field(); ?>
    <div class="modal-content">
      <div class="modal-header">
...
$("#_serach_baorce").focus();
  ...
  function setting_data_fetch(){
      var request = $.ajax({
            url: "<?php echo e(url('restaurant-sales-setting-modal')); ?>",
            method: "GET",
            dataType: "html"
          });
...
$(document).on("click",'._barcode_modal_button',function(){
  ...
  var request = $.ajax({
      url: "<?php echo e(url('item-restaurant-sales-search')); ?>",
      method: "GET",
      data: { _text_val : _text_val },
      dataType: "JSON"
    });
...
$(document).on("change","#_service_charge",function(){
      _purchase_total_calculation();
})
$(document).on("change","#_other_charge",function(){
      _purchase_total_calculation();
})
$(document).on("change","#_delivery_charge",function(){
      _purchase_total_calculation();
})
 ...
 function _purchase_total_calculation(){
  console.log('calculation here')
    ...
    var _total_discount_amount = 0;
      ...
      var _other_charge = $("#_other_charge").val();
      if(isNaN(_other_charge)){ _other_charge=0 }
      ...
      var _total = _math_round(parseFloat(_service_charge) + parseFloat(_other_charge) + parseFloat(_delivery_charge) + (parseFloat(_total__value)+parseFloat(_total__vat))-parseFloat(_total_discount));
     
      $("#_total").val(_total);
      $(".__total_payable_amouont").text(_total)
  }
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/backend/restaurant-sales/create.blade.php ENDPATH**/ ?>