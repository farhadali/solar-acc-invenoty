      ...
      <div class="container-fluid">
        ...
        <?php endif; ?>
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('user-wise-collection-payment-report')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/account-report/filter_user_receipt_payment.blade.php ENDPATH**/ ?>