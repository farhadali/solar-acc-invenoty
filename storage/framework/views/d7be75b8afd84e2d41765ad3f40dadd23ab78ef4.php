<div  >
              ...
              <div class="modal-content">
                ...
                <div class="modal-body search_modal">
                 <?php 
                  ...
                  <div class="form-group row">
                    <label for="_order_ref_id" class="col-sm-2 col-form-label"><?php echo e(__('label.issue_number')); ?>:</label>
                    <div class="col-sm-10">
                      <input type="text" id="_order_ref_id" name="_order_ref_id" class="form-control" placeholder="<?php echo e(__('label.issue_number')); ?>" 
                      value="<?php if(isset($request->_order_ref_id)): ?><?php echo e($request->_order_ref_id ?? ''); ?><?php endif; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="_search_main_ledger_id" name="_search_main_ledger_id" class="form-control _search_main_ledger_id" value="<?php if(isset($request->_search_main_ledger_id)): ?> <?php echo e($request->_search_main_ledger_id ?? ''); ?>  <?php endif; ?>" placeholder="<?php echo e(__('label._ledger_id')); ?>" >
                            <input type="hidden" id="_ledger_id" name="_ledger_id" class="form-control _ledger_id" value="<?php if(isset($request->_ledger_id)): ?><?php echo e($request->_ledger_id ?? ''); ?><?php endif; ?>" placeholder="<?php echo e(__('label._ledger_id')); ?>" required>
 ...
 <div class="form-group row">
  <div class="col-xs-2 col-sm-2 col-md-2 ">
     <label for="_master_organization_id " class=" col-form-label"><?php echo __('label.organization'); ?>:</label>
   </div>
                          ...
                          <div class="col-md-8">
                              <div class="form-group ">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="<?php echo e(url('material-issue-return')); ?>" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
                   
                  </form>
                </div><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/material-issue-return/search.blade.php ENDPATH**/ ?>