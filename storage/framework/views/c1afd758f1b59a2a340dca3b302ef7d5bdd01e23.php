                ...
                <div class="modal-body">
                 <?php 
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="_rate" name="_rate" class="form-control" placeholder="Search By Rate" value="<?php if(isset($request->_rate)): ?> <?php echo e($request->_rate ?? ''); ?>  <?php endif; ?>">
                    </div>
                  </div>
                          ...
                          <div class="col-md-8">
                              <div class="form-group mt-1">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="<?php echo e(url('vat-rules-reset')); ?>" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
                   
                  </form>
                </div><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/vat-rules/search.blade.php ENDPATH**/ ?>