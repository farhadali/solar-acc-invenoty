        ...
        <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
              ...
              <li class="breadcrumb-item active">
               ...
               attr_base_create_url="<?php echo e(route('account-group.create')); ?>">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="display: flex;">
                                ...
                                <button  type="button" 
                                  attr_base_edit_url="<?php echo e(route('account-group.show',$data->id)); ?>"
                                  data-toggle="modal" 
                                  data-target="#commonEntryModal_item" 
                                  ...
                                  <button  type="button" 
                                  attr_base_edit_url="<?php echo e(route('account-group.edit',$data->id)); ?>"
                                  data-toggle="modal" 
                                  data-target="#commonEntryModal_item" 
