        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
 <?php echo Form::model($data, ['method' => 'PATCH','route' => ['rlp-chain.update', $data->id]]); ?>                  <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/rlp-module/rlp-chain/edit.blade.php ENDPATH**/ ?>