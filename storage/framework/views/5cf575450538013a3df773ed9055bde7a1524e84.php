                    ...
                    <div class="row">
                      <input type="hidden" name="id" value="<?php echo e($data->id); ?>">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Code:</label>
                                <input type="text" name="_code" class="form-control" placeholder="Code" required="true" value="<?php echo e(old('_code',$data->_code ?? '')); ?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Address:</label>
                                <input type="text" name="_address" class="form-control" placeholder="Address" required="true" value="<?php echo e(old('_address',$data->_address)); ?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Date:</label>
                                <input type="date" name="_date" class="form-control" placeholder="Date" required="true" value="<?php echo e(old('_date',$data->_date)); ?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Email:</label>
                                <input type="email" name="_email" class="form-control" placeholder="Email" required="true" value="<?php echo e(old('_email',$data->_email)); ?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Phone:</label>
                                <input type="text" name="_phone" class="form-control" placeholder="Phone" required="true" value="<?php echo e(old('_phone',$data->_phone)); ?>">
                            </div>
                        </div>
