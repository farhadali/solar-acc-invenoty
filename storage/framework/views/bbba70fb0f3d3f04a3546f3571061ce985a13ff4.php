        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('report-expired-item')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    <div class="row">
                      <div class="col-md-6">
...
$(document).find('._item_category').on('change',function(){
    ...
    function _category_base_items(_category_id){
      var request = $.ajax({
          url: "<?php echo e(url('expired-item-cat-item')); ?>",
          method: "GET",
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/inventory-report/filter_expired_item.blade.php ENDPATH**/ ?>