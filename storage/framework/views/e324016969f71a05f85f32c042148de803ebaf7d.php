        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" >
               <form  action="<?php echo e(url('report-bill-party-statement')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    <div class="row">
                      <div class="col-md-6">
            ...
            <?php endif; ?>
                     ...
                     <div class="row">
                         <select id="_account_ledger_id" class="form-control select2 _account_ledger_id multiple_select" name="_account_ledger_id[]" required >
                          <?php if(isset($request->_account_ledger_id)  ): ?>
                           <?php $__empty_1 = true; $__currentLoopData = $account_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                           <option value="<?php echo e($group->id); ?>" <?php if($group->id== $previous_filter["_account_ledger_id"]): ?> selected <?php endif; ?> ><?php echo e($group->_name); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                           <?php endif; ?>
                          <?php endif; ?>
                         </select>
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="<?php echo e(url('reset-bill-party-statement')); ?>" class="btn btn-danger form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                        </div>
                        <br><br>
                     </div>
                    <?php echo Form::close(); ?>
...
<script type="text/javascript">
  ...
  function _nv_group_base_ledger(_account_group_id){
    var request = $.ajax({
        url: "<?php echo e(url('group-base-bill-party-ledger')); ?>",
        method: "GET",
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/inventory-report/filter_bill_of_party_statement.blade.php ENDPATH**/ ?>