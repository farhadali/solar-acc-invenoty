...
<div class="_report_button_header">
 <a class="nav-link"  href="<?php echo e(url('transfer')); ?>" role="button"><i class="fa fa-arrow-left"></i></a>
 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('transfer-edit')): ?>
    <a class="nav-link"  title="Edit" href="<?php echo e(route('transfer.edit',$data->id)); ?>">
       ...
       <table class="table table-bordered">
        ...
        <tbody>
          ...
          <?php
              ...
              $_stock_in_qty = 0;
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $data->_stock_out; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_key=>$_master_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/transfer/stock_out_print.blade.php ENDPATH**/ ?>