          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
              ...
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="<?php echo e(route('restaurant-sales.create')); ?>"> Add New </a>
               </li>
              <?php endif; ?>
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   ?>
                    <div class="col-md-4">
                       <?php echo $__env->make('backend.restaurant-sales.search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="col-md-8">
                      <div class="d-flex flex-row justify-content-end">
                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurant-sales-print')): ?>
                          ...
                          <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item " target="__blank" href="<?php echo e(url('restaurant-sales/print')); ?>/<?php echo e($data->id); ?>" >
                                         View & Print
                                      </a>
                                     <a class="dropdown-item " target="__blank" href="<?php echo e(url('kitchen-slip')); ?>/<?php echo e($data->id); ?>" >
                                        Kitchen Slip
                                      </a>
                                     <a class="dropdown-item " href="<?php echo e(url('restaurant-sales/challan')); ?>/<?php echo e($data->id); ?>" >
                                         Challan
                                      </a>
                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('restaurant-sales-edit')): ?>
                                        <a class="dropdown-item " href="<?php echo e(route('restaurant-sales.edit',$data->id)); ?>" >
                                          Edit
                                        </a>
                                    <?php endif; ?>
                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('money-receipt-print')): ?>
                                     
                                        <a class="dropdown-item " href="<?php echo e(url('restaurant-sales-money-receipt')); ?>/<?php echo e($data->id); ?>">
                                         Money Receipt
                                        </a>
                            ...
                            <td>
                              ...
                              <?php echo e($data->_order_ref_id ?? ''); ?> <br>
                              <?php endif; ?>
                              <b>Table NO:</b>
                              <?php
                              $tabless = explode(',', $data->_table_id ?? '');
                              ?>
                              <?php $__empty_1 = true; $__currentLoopData = $tabless; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                              
                            <span><?php echo e(_table_name($l_id)); ?></span><br>
                            
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                              <?php endif; ?>
                               <?php
                              $stewared = explode(',', $data->_served_by_ids ?? '');
                              ?>
                              <b>Served By:</b>
                              <?php $__empty_1 = true; $__currentLoopData = $stewared; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            
                              <span><?php echo e(_ledger_name($l_id)); ?></span><br>
...
function date__today(){
  ...
  $(document).on("click","._single_data_click",function(){
      ...
      $.ajaxSetup({ headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') } });
            $.ajax({
               type:'POST',
               url:"<?php echo e(url('restaurant-invoice-wise-detail')); ?>",
...
function after_request_date__today(_date){
 ...
 $(document).on('keyup','._search_main_sales_man_id',delay(function(e){
  ...
  $(document).on("click","._invoice_lock",function(){
    ...
    console.log(_id)
    var _table_name ="resturant_sales";
      if($(this).is(':checked')){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/backend/restaurant-sales/index.blade.php ENDPATH**/ ?>