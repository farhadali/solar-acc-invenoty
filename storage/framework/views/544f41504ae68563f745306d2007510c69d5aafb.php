        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <?php echo Form::model($data, ['method' => 'PATCH','route' => ['budgets.update', $data->id]]); ?>

               
                    <div class="row">
                       <input type="hidden" id="<?php echo $data->id; ?>" >
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details form_body" id="area__voucher_details">
                                            <?php $__empty_1 = true; $__currentLoopData = $_budget_details_income; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php
                                          ...
                                          ?>
                                            <tr class="_voucher_row">
                                              <td>
                                                ...
                                                <input type="hidden" name="_income_row_id[]" value="<?php echo e($in_val->id ?? 0); ?>">
                                              </td>
                                              <td>
                                                <input type="text" name="_search_ledger_id[]" class="form-control _search_ledger_id width_280_px" placeholder="Ledger" value="<?php echo $in_val->_ledger->_name ?? ''; ?>">
                                                <input type="hidden" name="_ledger_id[]" class="form-control _ledger_id"  value="<?php echo $in_val->_ledger_id; ?>">
                                                <div class="search_box"></div>
                                              </td>
                                              <td>
                                                <input type="text" name="_short_narr[]" class="form-control width_250_px _short_narr" placeholder="Short Narr" value="<?php echo $in_val->_short_narr ?? ''; ?>">
                                              </td>
                                              
                                              <td>
                                                <input type="number" name="_cr_amount[]" class="form-control  _cr_amount" placeholder="Amount" value="<?php echo e(old('_cr_amount',$in_val->_budget_amount)); ?>">
                                              </td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              <td>
                                                <input type="number" step="any" min="0" name="_total_cr_amount" class="form-control _total_cr_amount" value="<?php echo e($_total_income ?? 0); ?>" readonly required>
                                              </td>
                                            </tr>
                                          </tfoot>
                                      </table>
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            <?php $__empty_1 = true; $__currentLoopData = $_budget_item_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                             ...
                             ?>
                                            <tr class="_purchase_row">
                                              <td>
                                                ...
                                                <input type="hidden" name="_item_row_id[]" value="<?php echo e($i_val->id ?? 0); ?>">
                                              </td>
                                              <td>
                                                <input type="text" name="_search_item_id[]" class="form-control _search_item_id width_280_px" placeholder="Item" value="<?php echo $i_val->_item->_item ?? ''; ?>">
                                                <input type="hidden" name="_item_id[]" class="form-control _item_id width_200_px" value="<?php echo $i_val->_item_id ?? ''; ?>" >
                                              ...
                                              <td >
                                                <select class="form-control _transection_unit" name="_transection_unit[]">
                                                   <option value="<?php echo e($i_val->_item_unit_id); ?>"><?php echo e($i_val->_item->_units->_name ?? ''); ?></option>
                                                </select>
                                              </td>
                                              <td>
                                                <input type="number" name="_qty[]" class="form-control _qty _common_keyup" value="<?php echo $i_val->_item_qty ?? 0; ?>" >
                                              </td>
                                              <td>
                                                <input type="number" name="_rate[]" class="form-control _rate _common_keyup" value="<?php echo $i_val->_item_unit_price ?? 0; ?>" >
                                                
                                              </td>
                                             
                                              <td>
                                                <input type="number" name="_value[]" class="form-control _value " readonly value="<?php echo $i_val->_item_budget_amount ?? 0; ?>"  >
                                              </td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <?php endif; ?>
                                          ...
                                          <tfoot>
                                            <tr>
                                             ...
                                             <td></td>
                                              <td>
                                                <input type="number" step="any" min="0" name="_total_qty_amount" class="form-control _total_qty_amount" value="<?php echo e($total_qty ?? 0); ?>" readonly required>
                                              </td>
                                              <td></td>
                                              <td>
                                                <input type="number" step="any" min="0" name="_total_value_amount" class="form-control _total_value_amount" value="<?php echo e($_total_item_values ?? 0); ?>" readonly required>
                                              </td>
                                            </tr>
                                          </tfoot>
                                      </table>
                             ...
                             <div class="card ">
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          ...
                                          <tbody class="area__voucher_details_expenses form_body" id="area__voucher_details_expenses">
                                            <?php $__empty_1 = true; $__currentLoopData = $_budget_details_expense; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ex_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                              ...
                              ?>
                                            <tr class="_voucher_row">
                                              <td>
                                                <a  href="#none" class="btn btn-sm btn-default _voucher_row_remove" ><i class="fa fa-trash"></i></a>
                                                <input type="hidden" name="_exp_row_id[]" value="<?php echo e($ex_val->id ?? 0); ?>">
                                              </td>
                                              <td>
                                                <input type="text" name="_search_ledger_id[]" class="form-control _search_ledger_id width_280_px" placeholder="Ledger" value="<?php echo $ex_val->_ledger->_name ?? ''; ?>">
                                                <input type="hidden" name="_exp_ledger_id[]" class="form-control _ledger_id" value="<?php echo e($ex_val->_ledger_id); ?>">
                                                <div class="search_box"> </div>
                                              </td>
                                              <td>
                                                <select class="form-control" name='_ledger_type[]'>
                                                  <option value="expense" <?php if($ex_val->_ledger_type=='expense'): ?> selected <?php endif; ?>>Expenses</option>
                                                  <option value="deduction" <?php if($ex_val->_ledger_type=='deduction'): ?> selected <?php endif; ?>>Deduction</option>
                                                </select>
                                              </td>
                                              <td>
                                                <input type="text" name="_exp_short_narr[]" class="form-control width_250_px _short_narr" placeholder="Short Narr" value="<?php echo $ex_val->_short_narr ?? ''; ?>">
                                              </td>
                                              <td>
                                                <input type="number" name="_exp_dr_amount[]" class="form-control  _dr_amount" placeholder="Dr. Amount" value="<?php echo e(old('_dr_amount',$ex_val->_budget_amount)); ?>">
                                              </td>
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              <td></td>
                                              <td>
                                                <input type="number" step="any" min="0" name="_total_dr_amount" class="form-control _total_dr_amount" value="<?php echo e($exp_total_amount ?? 0); ?>" readonly required>
                                              </td>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;">
                            ...
                            <tr>
                              ...
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="expected_income" class="form-control width_200_px" id="expected_income" readonly value="<?php echo $data->_income_amount ?? 0; ?>">
                              </td>
                            </tr>
                            <tr>
                              <td style="width: 20%;border:0px;"><label for="expected_material_expense"><?php echo e(__('label.expected_material_expense')); ?></label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="expected_material_expense" class="form-control width_200_px" id="expected_material_expense" readonly value="<?php echo $data->_material_amount ?? 0; ?>">
                              </td>
                            </tr>
                            <tr>
                              <td style="width: 20%;border:0px;"><label for="expected_other_expenses"><?php echo e(__('label.expected_other_expenses')); ?></label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="expected_other_expenses" class="form-control width_200_px" id="expected_other_expenses" readonly value="<?php echo $data->_expense_amount ?? 0; ?>">
                              </td>
                            </tr>
                            <tr>
                              <td style="width: 20%;border:0px;"><label for="expected_profit"><?php echo e(__('label.expected_profit')); ?></label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="expected_profit" class="form-control width_200_px" id="expected_profit" readonly value="<?php echo $data->_income_amount-($data->_material_amount+$data->_expense_amount); ?>">
                              </td>
                            </tr>
                            ...
                            <tr class="display_none">
                              ...
                              <td style="width: 70%;border:0px;">
                          <input type="text" name="_total" class="form-control width_200_px" id="_purchase_total" readonly value="<?php echo e(0); ?>">
                              </td>
                            </tr>
...
$(document).on('keyup','._common_keyup',function(){
 ...
 var single_row =  `<tr class="_voucher_row">
                      ...
                      <div class="search_box">
                            ...
                            <td>
                              <input type="number" step="any" name="_cr_amount[]" class="form-control  _cr_amount" placeholder="Cr. Amount" value="<?php echo e(old('_cr_amount',0)); ?>">
                              </td>
                            </tr>`;
  ...
  var expense_single_row = `<tr class="_voucher_row">
                                              ...
                                              <td>
                                                <input type="number" step="any" name="_exp_dr_amount[]" class="form-control  _dr_amount" placeholder="Dr. Amount" value="<?php echo e(old('_exp_dr_amount',0)); ?>">
                                              </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/budgets/edit.blade.php ENDPATH**/ ?>