<div  >
    ...
    <div class="modal fade" id="modal-default">
                ...
                <div class="modal-body search_modal">
                 <?php 
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="_order_ref_id" name="_order_ref_id" class="form-control" placeholder="Search By Order Number" value="<?php if(isset($request->_order_ref_id)): ?><?php echo e($request->_order_ref_id ?? ''); ?><?php endif; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
        ...
        <!-- /.modal-dialog -->
                ...
                </div><?php /**PATH D:\xampp\htdocs\solar-acc-invenoty\resources\views/backend/sales-order/search.blade.php ENDPATH**/ ?>