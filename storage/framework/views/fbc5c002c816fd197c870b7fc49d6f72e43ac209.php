  ...
  <div class="content ">
    ...
    <?php echo $__env->make('backend.message.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="card-body p-4" >
               <?php echo Form::model($data, ['method' => 'PATCH','route' => ['leave-type.update', $data->id]]); ?>

                <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label> <?php echo e(__('label._type')); ?>:</label>
                                <?php echo Form::text('_type', null, array('placeholder' => __('label._type'),'class' => 'form-control','required' => 'true')); ?>

                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label><?php echo e(__('label._number_of_days')); ?>:</label>
                                <?php echo Form::text('_number_of_days', null, array('placeholder' => __("label._number_of_days"),'class' => 'form-control','required' => 'true')); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/hrm/leave-type/edit.blade.php ENDPATH**/ ?>