        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="<?php echo e(url('cost-center-authorization-chain')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                       <?php
$users = \Auth::user();
                        ...
                        <tr class="_purchase_row">
                          ...
                          <td>
                              <select class="form-control select2" name="user_id[]">
                                ...
                                <option value="<?php echo $uval->office_id; ?>" <?php if($val->erp_user_id==$uval->office_id): ?> selected <?php endif; ?> ><?php echo $uval->office_id ?? ''; ?>-<?php echo $uval->name ?? ''; ?></option>
...
<option value="<?php echo $uval->office_id; ?>"><?php echo $uval->office_id ?? ''; ?>-<?php echo $uval->name ?? ''; ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <?php endif; ?>
                  </select>
              </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\solar-acc-invenoty\resources\views/backend/cost-center/authorised_chain.blade.php ENDPATH**/ ?>