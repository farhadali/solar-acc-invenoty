...
<div class="wrapper print_content">
  ...
  <div class="_report_button_header">
    <a class="nav-link"  href="<?php echo e(url('sales-return-detail')); ?>" role="button">
            ...
            <?php $__empty_3 = true; $__currentLoopData = $master_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d_key=> $del_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_3 = false; ?>
              <tr>
                <th colspan="9" class="text-left">
                  <a style="text-decoration: none;" target="__blank" href="<?php echo e(url('sales-return/print',$del_val->id)); ?>">
              ...
              <tr>
                ...
                <td class="text-right"><?php echo _report_amount($_master_details->_rate ?? 0 * $_master_details->_unit_conversion ?? 0); ?></td>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/inventory-report/report_date_wise_sales_return_statement.blade.php ENDPATH**/ ?>