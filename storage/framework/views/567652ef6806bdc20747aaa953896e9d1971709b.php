...
<div class="_report_button_header">
  <a class="nav-link"  href="<?php echo e(url('purchase-return')); ?>" role="button"><i class="fa fa-arrow-left"></i></a>
 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase-return-edit')): ?>

    <a class="nav-link"  title="Edit"
    href="<?php echo e(route('purchase-return.edit',$data->id)); ?>"><i class="nav-icon fas fa-edit"></i></a>
  <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/purchase-return/print_3.blade.php ENDPATH**/ ?>