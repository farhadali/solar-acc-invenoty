          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">
                 <a class="btn btn-primary" href="<?php echo e(route('vat-rules.index')); ?>"> <i class="fa fa-th-list" aria-hidden="true"></i></a>
               </li>
               <?php endif; ?>
            </ol>
          </div><!-- /.col -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <?php echo Form::open(array('route' => 'vat-rules.store','method'=>'POST')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>Rate:</label>
                                <?php echo Form::text('_rate', null, array('placeholder' => 'Rate','class' => 'form-control')); ?>
...
<?php /**PATH D:\xampp\htdocs\solar-acc-invenoty\resources\views/backend/vat-rules/create.blade.php ENDPATH**/ ?>