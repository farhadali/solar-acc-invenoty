...
<div class="tab-pane active" id="tab1">
    ...
    <div class="form-group row pt-2">
                            <label class="col-sm-2 col-form-label" ><?php echo e(__('EMP ID')); ?>:</label>
                             <div class="col-sm-6">
                                ...
                                <input type="text" name="_employee_id_text" class="form-control _employee_id_text" placeholder="<?php echo e(__('EMP ID')); ?>" value="<?php echo e(old('_employee_id_text',$data->_number ?? '')); ?>" required>
    ...
    <div class="form-group row">
            <label class="col-sm-2 col-form-label"  for="_type" class="_required"><?php echo e(__('Type')); ?>:</label>
            <div class="col-sm-2 ">
                <select class="form-control" name="_type" id="_type" required>
                  <option value="1" <?php if($data->_type==1): ?> selected <?php endif; ?> >IN</option>
                  <option value="2" <?php if($data->_type==2): ?> selected <?php endif; ?> >OUT</option>
                </select>
            </div>
    </div>
     
     <div class="form-group row">
        <label class="col-sm-2 col-form-label" for="_datetime"><?php echo e(__('Time')); ?>:</label>
        <div class="col-sm-2">
            <input class="form-group" type="datetime-local" id="_datetime" name="_datetime" value="<?php echo e(old('_datetime',$data->_datetime)); ?>" required>
        </div>
</div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/hrm/attandance/edit.blade.php ENDPATH**/ ?>