          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">
                 <a class="btn btn-primary" href="<?php echo e(route('mother-vessel-info.index')); ?>"> <i class="fa fa-th-list" aria-hidden="true"></i></a>
               </li>
               <?php endif; ?>
            </ol>
          </div><!-- /.col -->
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <?php echo Form::model($data, ['method' => 'PATCH','route' => ['mother-vessel-info.update', $data->id]]); ?> 
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="_type">
                                    ...
                                    <option value="<?php echo e($key); ?>" <?php if($data->_type==$key): ?> selected <?php endif; ?>><?php echo e($val); ?></option>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/mother-vessel-info/edit.blade.php ENDPATH**/ ?>