                       ...
                       <div class="col-xs-12 col-sm-12 col-md-3">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_vessel_no" name="_vessel_no" class="form-control _vessel_no" value="<?php echo e(old('_vessel_no')); ?>" placeholder="<?php echo e(__('label._vessel_no')); ?>" >
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                                ...
                                <div class="table-responsive">
                                      <table class="table table-bordered" >
                                          <thead >
                                            ...
                                            <th class="text-left <?php if(isset($_show_unit)): ?> <?php if($_show_unit==0): ?> display_none    <?php endif; ?> <?php endif; ?>" >Tran. Unit</th>
                                           
                                            <th class="text-left <?php if($_show_barcode==0): ?> display_none    <?php endif; ?> " >Barcode</th>
                                            <th class="text-left <?php if($_show_short_note==0): ?> display_none    <?php endif; ?> " >Note</th>
                                            ...
                                            <th class="text-left <?php if(isset($_show_sd)): ?> <?php if($_show_sd==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._sd')); ?>%</th>
                                            <th class="text-left <?php if(isset($_show_sd)): ?> <?php if($_show_sd==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._sd_amount')); ?></th>

                                            <th class="text-left <?php if(isset($_show_cd)): ?> <?php if($_show_cd==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._cd')); ?>%</th>
                                            <th class="text-left <?php if(isset($_show_cd)): ?> <?php if($_show_cd==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._cd_amount')); ?></th>

                                            <th class="text-left <?php if(isset($_show_ait)): ?> <?php if($_show_ait==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._ait')); ?>%</th>
                                            <th class="text-left <?php if(isset($_show_ait)): ?> <?php if($_show_ait==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._ait_amount')); ?></th>

                                            <th class="text-left <?php if(isset($_show_rd)): ?> <?php if($_show_rd==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._rd')); ?>%</th>
                                            <th class="text-left <?php if(isset($_show_rd)): ?> <?php if($_show_rd==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._rd_amount')); ?></th>

                                            <th class="text-left <?php if(isset($_show_at)): ?> <?php if($_show_at==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._at')); ?>%</th>
                                            <th class="text-left <?php if(isset($_show_at)): ?> <?php if($_show_at==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._at_amount')); ?></th>

                                            <th class="text-left <?php if(isset($_show_tti)): ?> <?php if($_show_tti==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._tti')); ?>%</th>
                                            <th class="text-left <?php if(isset($_show_tti)): ?> <?php if($_show_tti==0): ?> display_none   <?php endif; ?> <?php endif; ?>" ><?php echo e(__('label._tti_amount')); ?></th>
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            <tr class="_purchase_row">
                                              ...
                                              <td class="<?php if(isset($_show_sd)): ?> <?php if($_show_sd==0): ?> display_none  <?php endif; ?> <?php endif; ?> ">
                                              ...
                                              <td class="<?php if(isset($_show_cd)): ?> <?php if($_show_cd==0): ?> display_none  <?php endif; ?> <?php endif; ?> ">
                                              ...
                                              <td class="<?php if(isset($_show_ait)): ?> <?php if($_show_ait==0): ?> display_none  <?php endif; ?> <?php endif; ?> ">
                                              ...
                                              <td class="<?php if(isset($_show_rd)): ?> <?php if($_show_rd==0): ?> display_none  <?php endif; ?> <?php endif; ?> ">
                                              ...
                                              <td class="<?php if(isset($_show_at)): ?> <?php if($_show_at==0): ?> display_none  <?php endif; ?> <?php endif; ?> ">
                                              ...
                                              <td class="<?php if(isset($_show_tti)): ?> <?php if($_show_tti==0): ?> display_none  <?php endif; ?> <?php endif; ?> ">
                      ...
                      <?php endif; ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;">
                            ...
                            <tr class="<?php if($_show_ait==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._ait')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_inv_ait_per" class=" width_200_px" id="_purchase_inv_ait_per"  value="0"  placeholder="<?php echo e(__('label._ait')); ?>%">
                                <input type="text" name="_inv_ait_amount" class="width_200_px" id="_purchase_inv_ait_amount"  value="0" placeholder="<?php echo e(__('label._ait_amount')); ?>">
                              </td>
                            </tr>
                            <tr class="<?php if($_show_ait==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._total_ait_amount')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_total_ait_amount" class="form-control width_200_px" id="_purchase_total_ait_amount"  value="0"  placeholder="<?php echo e(__('label._total_ait_amount')); ?>" readonly>
                                
                              </td>
                            </tr>
                            <tr class="<?php if($_show_sd==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._sd')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_inv_sd_per" class=" width_200_px" id="_purchase_inv_sd_per"  value="0"  placeholder="<?php echo e(__('label._sd')); ?>%">
                                <input type="text" name="_inv_sd_amount" class="width_200_px" id="_purchase_inv_sd_amount"  value="0" placeholder="<?php echo e(__('label._sd_amount')); ?>">
                              </td>
                            </tr>
                            <tr class="<?php if($_show_sd==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._total_sd_amount')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_total_sd_amount" class="form-control width_200_px" id="_purchase_total_sd_amount"  value="0"  placeholder="<?php echo e(__('label._total_sd_amount')); ?>" readonly>
                                
                              </td>
                            </tr>
                            <tr class="<?php if($_show_cd==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._cd')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_inv_cd_per" class=" width_200_px" id="_purchase_inv_cd_per"  value="0"  placeholder="<?php echo e(__('label._cd')); ?>%">
                                <input type="text" name="_inv_cd_amount" class="width_200_px" id="_purchase_inv_cd_amount"  value="0" placeholder="<?php echo e(__('label._cd_amount')); ?>">
                              </td>
                            </tr>
                            <tr class="<?php if($_show_cd==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._total_cd_amount')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_total_cd_amount" class="form-control width_200_px" id="_purchase_total_cd_amount"  value="0"  placeholder="<?php echo e(__('label._total_cd_amount')); ?>" readonly>
                                
                              </td>
                            </tr>
                            <tr class="<?php if($_show_rd==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._rd')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_inv_rd_per" class=" width_200_px" id="_purchase_inv_rd_per"  value="0"  placeholder="<?php echo e(__('label._rd')); ?>%">
                                <input type="text" name="_inv_rd_amount" class="width_200_px" id="_purchase_inv_rd_amount"  value="0" placeholder="<?php echo e(__('label._rd_amount')); ?>">
                              </td>
                            </tr>
                            <tr class="<?php if($_show_rd==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._total_rd_amount')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_total_rd_amount" class="form-control width_200_px" id="_purchase_total_rd_amount"  value="0"  placeholder="<?php echo e(__('label._total_rd_amount')); ?>" readonly>
                                
                              </td>
                            </tr>
                            <tr class="<?php if($_show_at==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._at')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_inv_at_per" class=" width_200_px" id="_purchase_inv_at_per"  value="0"  placeholder="<?php echo e(__('label._at')); ?>%">
                                <input type="text" name="_inv_at_amount" class="width_200_px" id="_purchase_inv_at_amount"  value="0" placeholder="<?php echo e(__('label._at_amount')); ?>">
                              </td>
                            </tr>
                            <tr class="<?php if($_show_at==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._total_at_amount')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_total_at_amount" class="form-control width_200_px" id="_purchase_total_at_amount"  value="0"  placeholder="<?php echo e(__('label._total_at_amount')); ?>" readonly>
                                
                              </td>
                            </tr>
                            <tr class="<?php if($_show_tti==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._tti')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_inv_tti_per" class=" width_200_px" id="_purchase_inv_tti_per"  value="0"  placeholder="<?php echo e(__('label._tti')); ?>%">
                                <input type="text" name="_inv_tti_amount" class="width_200_px" id="_purchase_inv_tti_amount"  value="0" placeholder="<?php echo e(__('label._tti_amount')); ?>">
                              </td>
                            </tr>
                            <tr class="<?php if($_show_tti==0): ?> display_none <?php endif; ?>">
                              <td style="width: 10%;border:0px;"><label for="_total_vat"><?php echo e(__('label._total_tti_amount')); ?>%</label></td>
                              <td style="width: 70%;border:0px;">
                                <input type="text" name="_total_tti_amount" class="form-control width_200_px" id="_purchase_total_tti_amount"  value="0"  placeholder="<?php echo e(__('label._total_tti_amount')); ?>" readonly>
   ...
   var _item_row_count = (parseFloat(i)+1);
    ...
    $(document).find("._item_row_count").val(_item_row_count)
      ...
      $(document).find("#area__purchase_details").append(`<tr class="_purchase_row">
                                              ...
                                              <td class=" <?php if($_show_cd==0): ?> display_none  <?php endif; ?>  ">
                                                <input type="number" name="_cd[]" class="form-control  _cd _common_keyup" >
                                              </td>
                                              <td class=" <?php if($_show_cd==0): ?> display_none  <?php endif; ?> ">
                                                <input type="number" name="_cd_amount[]" class="form-control  _cd_amount" >
