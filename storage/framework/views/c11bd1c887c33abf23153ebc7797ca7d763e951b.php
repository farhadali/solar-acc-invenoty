            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   ?>
                    <div class="col-md-4">
                       <?php echo $__env->make('backend.purchase-return.search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="col-md-8">
                      <div class="d-flex flex-row justify-content-end">
                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase-return-print')): ?>
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td style="display: flex;">
                                ...
                                <a  type="button" 
                                  href="<?php echo e(url('purchase-return/print')); ?>/<?php echo e($data->id); ?>"
                                   
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>


                                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase-return-edit')): ?>
                                  <a  href="<?php echo e(route('purchase-return.edit',$data->id)); ?>" 
                          ...
                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('money-receipt-print')): ?>
                              ...
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item " href="<?php echo e(url('purchase-return-money-receipt')); ?>/<?php echo e($data->id); ?>">
                                         Money Receipt
                                        </a>
                            ...
                            <td>
                              <a target="__blank" href="<?php echo e(url('purchase/print')); ?>/<?php echo e($data->_order_ref_id); ?>"><?php echo e($data->_order_ref_id ?? ''); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/purchase-return/index.blade.php ENDPATH**/ ?>