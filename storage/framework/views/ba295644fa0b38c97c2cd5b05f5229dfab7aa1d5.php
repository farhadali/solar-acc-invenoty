        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body filter_body" style="">
               <form  action="<?php echo e(url('work-sheet-report')); ?>" method="GET">
                <?php echo csrf_field(); ?>
                    <div class="row">
                      <div class="col-md-12">
                      ...
                      <div class="col-md-12 <?php if(sizeof($permited_branch) == 1): ?> display_none <?php endif; ?> " >
                          <label>Branch:</label>
                      ...
                      <div class="col-md-12 <?php if(sizeof($permited_costcenters) == 1): ?> display_none <?php endif; ?> ">
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="<?php echo e(url('work-sheet-filter-reset')); ?>" class="btn btn-danger form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                        </div>
                        <br><br>
                     </div>
                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/account-report/work-sheet.blade.php ENDPATH**/ ?>