 <div class="col-md-12  ">
                                      ...
                                      <table class="table table-bordered" >
                                          ...
                                          <tfoot>
                                            <tr>
                                              ...
                                              <td>
                                                <input type="number" step="any" min="0" name="_total_dr_amount" class="form-control _total_dr_amount" value="<?php echo e($_account_dr_total); ?>" readonly required>
                                              </td>


                                              <td>
                                                <input type="number" step="any" min="0" name="_total_cr_amount" class="form-control _total_cr_amount" value="<?php echo e($_account_cr_total); ?>" readonly required>
                                              </td>
                                            </tr>
                                          </tfoot>
                                      </table>
                        ...
                        </div><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/purchase-return/edit_ac_detail.blade.php ENDPATH**/ ?>