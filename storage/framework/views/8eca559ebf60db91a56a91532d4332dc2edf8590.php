<div  >
    ...
    <div class="modal fade" id="modal-default">
        ...
        <!-- /.modal-dialog -->
                        ...
                        <div class="row">
                          <div class="col-md-12 d-flex">
                            ...
                            <div class="form-group ml-2">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('import-purchase-create')): ?>
                             
                                    <a title="Add New" class="btn btn-info btn-sm mr-1" href="<?php echo e(route('import-purchase.create')); ?>"><i class="nav-icon fas fa-plus"></i> Create New </a>
                                  <?php endif; ?>
                              </div>
                              ...
                              <div class="form-group ml-2">
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="<?php echo e(url('import-purchase-reset')); ?>" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                ...
                </div><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/import-purchase/search.blade.php ENDPATH**/ ?>