...
<div class="content-header">
      <div class="container-fluid">
         ...
         <div class="col-sm-12" style="display: flex;">
             <a class="m-0 _page_name" href="<?php echo e(route('mother-vessel-info.index')); ?>"> <?php echo $page_name ?? ''; ?> </a>
            <ol class="breadcrumb float-sm-right ml-2">
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mother-vessel-info-create')): ?>
              <li class="breadcrumb-item active">
                <a type="button" 
               class="btn btn-sm btn-info active " 
               href="<?php echo e(route('mother-vessel-info.create')); ?>">
            ...
            <div class="card">
              <div class="card-header border-0">
                 ...
                 <div class="row">
                   ...
                   ?>
                    <div class="col-md-4">
                      <?php echo $__env->make('backend.mother-vessel-info.search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="col-md-8">
                      ...
                      <tbody>
                        ...
                        <tr>
                             <td style="display: flex;">
                                ...
                                <a  
                                  href="<?php echo e(route('mother-vessel-info.show',$data->id)); ?>"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>


                                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mother-vessel-info-edit')): ?>
                                  <a  
                                  href="<?php echo e(route('mother-vessel-info.edit',$data->id)); ?>"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-pen "></i>
                                </a>
                                  <?php endif; ?>
                                  
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mother-vessel-info-delete')): ?>
                                 <?php echo Form::open(['method' => 'DELETE','route' => ['mother-vessel-info.destroy', $data->id],'style'=>'display:inline']); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/mother-vessel-info/index.blade.php ENDPATH**/ ?>