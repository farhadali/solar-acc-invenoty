<div  >
    ...
    <div class="modal fade" id="modal-default">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                       <select class=" form-control" name="_account_head_id">
                        ...
                        <?php $__currentLoopData = $account_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val->id); ?>" <?php if(isset($request->_account_head_id)): ?> <?php if($val->id==$request->_account_head_id): ?> selected <?php endif; ?> <?php endif; ?> ><?php echo e($val->_name ?? ''); ?></option>
        ...
        <!-- /.modal-dialog -->
                ...
                </div><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/account-group/search.blade.php ENDPATH**/ ?>