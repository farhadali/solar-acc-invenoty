...
<div class="wrapper print_content">
  ...
  <div class="_report_button_header">
    <a class="nav-link"  href="<?php echo e(url('filter-actual-sales')); ?>" role="button">
            ...
            <?php $__empty_3 = true; $__currentLoopData = $master_val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d_key=> $del_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_3 = false; ?>
              <tr>
                <th colspan="9" class="text-left">
                  <a style="text-decoration: none;" target="__blank" href="<?php echo e(url('sales/print',$del_val->id)); ?>">
              ...
              <tr>
                ...
                <td class="text-left"><?php echo $_master_details->_barcode ?? ''; ?></td>
                <td class="text-left"><?php echo $_master_details->_items->_units->_name ?? ''; ?></td>
                <td class="text-right"><?php echo _report_amount($_master_details->_qty ?? 0); ?></td>
                <td class="text-right"><?php echo _report_amount($_master_details->_sales_rate ?? 0); ?></td>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/inventory-report/report_actual_sales.blade.php ENDPATH**/ ?>