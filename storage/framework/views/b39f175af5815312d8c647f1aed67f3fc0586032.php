<div  >
                          ...
                          <div class="col-md-2">
                            <select class="form-control" name="_branch_id" >
                              <option value="">--Select Branch--</option>
                                  ...
                                  <option value="<?php echo e($branch->id); ?>" <?php if($request->_branch_id==$branch->id): ?> selected <?php endif; ?>><?php echo e($branch->_name ?? ''); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                  <?php endif; ?>
                ...
                </div><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/backend/cost-center/search.blade.php ENDPATH**/ ?>