                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3  <?php if($_show_vn==0): ?> display_none <?php endif; ?>">
                            <div class="form-group">
                              ...
                              <input type="text" name="_name_of_master" class="form-control" placeholder="<?php echo e(__('label._name_of_master')); ?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-2  <?php if($_show_vn==0): ?> display_none <?php endif; ?>">
                            <div class="form-group">
                              ...
                              <input type="text" name="_mobile_of_master" class="form-control" placeholder="<?php echo e(__('label._mobile_of_master')); ?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-2  <?php if($_show_vn==0): ?> display_none <?php endif; ?>">
                            <div class="form-group">
                              <label class="mr-2" for="_loading_place"><?php echo e(__('label._loding_point')); ?>:</label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="datetime-local" id="_loading_date_time" name="_loading_date_time" class="form-control _loading_date_time" value="<?php echo e(old('_loading_date_time')); ?>" placeholder="<?php echo e(__('label._loading_date_time')); ?>" >
                            </div>
                        </div>
