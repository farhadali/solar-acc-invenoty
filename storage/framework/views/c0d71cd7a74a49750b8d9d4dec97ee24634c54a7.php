...
<div class="content-header">
          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item ">
                 <a target="__blank" href="<?php echo e(url('sales-return/print')); ?>/<?php echo e($data->id); ?>" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
             ...
             <li class="breadcrumb-item ">
               ...
               <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('sales-return-settings')): ?>
             <li class="breadcrumb-item ">
              ...
              <?php endif; ?>
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="<?php echo e(route('sales-return.index')); ?>"> <i class="nav-icon fas fa-list"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
   ...
   $_inline_discount = $form_settings->_inline_discount ?? 0;
    ...
    ?>
              <div class="card-body">
               <form action="<?php echo e(url('sales-return/update')); ?>" method="POST" class="purchase_form" >
                <?php echo csrf_field(); ?>
                    <div class="row">
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input readonly type="text" id="_search_order_ref_id" name="_search_order_ref_id" class="form-control _search_order_ref_id" value="<?php echo e(old('_order_ref_id',$data->_order_ref_id)); ?>" placeholder="Sales Invoice" >
 ...
 <script type="text/javascript">
  $('#<?php echo ($m_key+1);?>__barcode').amsifySuggestags({
      ...
      showPlusAfter: 1,
                                            ...
                                            <?php endif; ?>
                                              ...
                                              <td class="<?php if(isset($form_settings->_show_expire_date)): ?> <?php if($form_settings->_show_expire_date==0): ?> display_none  <?php endif; ?> <?php endif; ?>">
                                               ...
                                               <td class="<?php if(sizeof($permited_branch) == 1): ?> display_none <?php endif; ?> ">
                                                <select class="form-control  _main_branch_id_detail" name="_main_branch_id_detail[]"  required>
                                                  ...
                                                  <option value="<?php echo e($branch->id); ?>" <?php if(isset($_detail->_branch_id)): ?> <?php if($_detail->_branch_id == $branch->id): ?> selected <?php endif; ?>   <?php endif; ?>><?php echo e($branch->_name ?? ''); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                  <?php endif; ?>
                                                </select>
                                              </td>
                                               ...
                                               <td class=" <?php if(sizeof($permited_costcenters) == 1): ?> display_none <?php endif; ?> " >
                                                 <select class="form-control  _main_cost_center" name="_main_cost_center[]" required >
                                                  ...
                                                  <option value="<?php echo e($costcenter->id); ?>" <?php if(isset($_detail->_cost_center_id)): ?> <?php if($_detail->_cost_center_id == $costcenter->id): ?> selected <?php endif; ?>   <?php endif; ?>> <?php echo e($costcenter->_name ?? ''); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                  <?php endif; ?>
                                                </select>
                                              </td>
                                              ...
                                              <td class=" <?php if(sizeof($store_houses) == 1): ?> display_none <?php endif; ?> ">
                                                <select class="form-control  _main_store_id" name="_main_store_id[]">
                                                  ...
                                                  <option value="<?php echo e($store->id); ?>" <?php if($_detail->_store_id ==$store->id): ?> selected <?php endif; ?>  ><?php echo e($store->_name ?? ''); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                  <?php endif; ?>
                                                </select>
              ...
              <?php echo $__env->make('backend.sales-return.edit_ac_cb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                 
              <?php else: ?>
               <?php echo $__env->make('backend.sales-return.edit_ac_detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
              <?php endif; ?>           
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="<?php echo e(url('sales-return-settings')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<script type="text/javascript">
  ...
  function setting_data_fetch(){
      var request = $.ajax({
            url: "<?php echo e(url('sales-return-setting-modal')); ?>",
            method: "GET",
            dataType: "html"
          });
  ...
  var request = $.ajax({
      url: "<?php echo e(url('sales-order-search')); ?>",
      method: "GET",
...
$(document).on("click",'.search_row_purchase_order',function(){
    ...
    var request = $.ajax({
      url: "<?php echo e(url('sales-order-details')); ?>",
      method: "POST",
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/sales-return/edit.blade.php ENDPATH**/ ?>