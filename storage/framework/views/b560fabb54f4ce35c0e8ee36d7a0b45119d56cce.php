          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               <?php endif; ?>
               <form action="<?php echo e(url('transfer/update')); ?>" method="POST" class="purchase_form" >
                <?php echo csrf_field(); ?>
                    <div class="row">
               ...
               <div class="form-group ">
                  ...
                  <select class="form-control " name="_from_organization_id" required >
                     ...
                     <?php endif; ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 " >
                            <div class="form-group ">
                                <label><?php echo e(__('label._order_number')); ?>:</label>
                               <input type="hidden" name="id" readonly value="<?php echo e($data->id); ?>" class="form-control">
                               <input type="text" name="_invoice_number" readonly value="<?php echo e($data->_invoice_number); ?>" class="form-control">
                            </div>
                        </div>
                        <?php
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/transfer/edit.blade.php ENDPATH**/ ?>