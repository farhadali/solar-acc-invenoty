<div  >
                    ...
                    <?php echo csrf_field(); ?>
                     <?php 
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <input type="text" name="_address" class="form-control" placeholder="Address" value="<?php if(isset($request->_address)): ?> <?php echo e($request->_address ?? ''); ?>  <?php endif; ?>">
                          </div>
                          
                          <div class="col-md-2">
                            <input type="text" name="_email" class="form-control" placeholder="Email" value="<?php if(isset($request->_email)): ?> <?php echo e($request->_email ?? ''); ?>  <?php endif; ?>">
                          </div>
                          <div class="col-md-2">
                            <input type="text" name="_phone" class="form-control" placeholder="Phone" value="<?php if(isset($request->_phone)): ?> <?php echo e($request->_phone ?? ''); ?>  <?php endif; ?>">
                          </div>
                ...
                </div><?php /**PATH /home/sobuz23/sspf.sobuzsathitraders.com/resources/views/backend/branch/search.blade.php ENDPATH**/ ?>