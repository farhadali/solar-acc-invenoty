     ...
     <div class="row">
      <div class="col-12 table-responsive">
       <table class="table table-bordered">
        ...
        <tbody>
          <tr>
          <td colspan="8" class="text-left" > <b>Stock In</b></td>
         </tr>
          <tr>
            <th>ID</th>
            <th>Item</th>
          ...
          <tr>
          <td colspan="8" class="text-left" > <b>Stock Out</b></td>
         </tr>
          ...
          <tr>
            ...
            <?php
              ...
              <tr>
            <td colspan="4" class="text-left"><b>Total</b></td>
            <td><b><?php echo e(_report_amount($_stock_out_qty ?? 0 )); ?> </b></td>
            <td colspan="2"></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/transfer/print.blade.php ENDPATH**/ ?>