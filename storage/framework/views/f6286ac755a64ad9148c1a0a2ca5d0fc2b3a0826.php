        ...
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('material-issue-return-create')): ?>
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="<?php echo e(route('material-issue-return.create')); ?>"> Add New </a>
               </li>
              <?php endif; ?>
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   ?>
                    <div class="col-md-4">
                       <?php echo $__env->make('backend.material-issue-return.search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="col-md-8">
                      <div class="d-flex flex-row justify-content-end">
                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('material-issue-return-print')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/backend/material-issue-return/index.blade.php ENDPATH**/ ?>