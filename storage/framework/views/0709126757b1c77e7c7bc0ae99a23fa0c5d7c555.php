...
<div class="wrapper print_content">
  ...
  <div class="_report_button_header">
    <a class="nav-link"  href="<?php echo e(url('single-stock-ledger')); ?>" role="button">
   ...
   <table class="cewReportTable">
          ...
          <tbody>
            ...
            <?php if(sizeof($_branch_ids) > 1 ): ?>
             ...
             <?php endif; ?>
             <?php echo e($_item_id); ?> | <?php echo e(_item_name($_item_id)); ?>
            ...
            <td style="text-transform: capitalize;white-space: nowrap;"><?php echo $g_value->_transection ?? ''; ?> </td>
            ...
            <td style="width: 10%;white-space: nowrap;"><?php echo _view_date_formate($g_value->_date ?? ''); ?></td>
            <td style="width: 10%;"><?php echo _find_unit($g_value->_unit_id); ?></td>
            <td style="width: 10%;white-space: nowrap;" class="text-right"><?php echo _report_amount($g_value->_stockin); ?></td>
            <td style="width: 10%;white-space: nowrap;" class="text-right"><?php echo _report_amount($g_value->_stockout); ?></td>
            <td style="width: 10%;white-space: nowrap;" class="text-right"><?php echo e(_report_amount( $_sub_total_balance)); ?></td>
          </tr>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/backend/inventory-report/report_single_stock_ledger.blade.php ENDPATH**/ ?>