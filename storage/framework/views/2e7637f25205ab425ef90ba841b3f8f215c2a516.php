  ...
  <div class="content ">
    ...
    <?php echo $__env->make('backend.message.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="card-body p-4" >
               <?php echo Form::model($data, ['method' => 'PATCH','route' => ['hrm-designation.update', $data->id]]); ?>

                <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label><?php echo e(__('label.name')); ?>:<span class="_required">*</span></label>
                                <input class="form-control" type="text" name="_name" placeholder="<?php echo e(__('label.name')); ?>" value="<?php echo e(old('_name',$data->_name ?? '' )); ?>" required>
                            </div>
                        </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\inv-acc-hrm\resources\views/hrm/hrm-designation/edit.blade.php ENDPATH**/ ?>