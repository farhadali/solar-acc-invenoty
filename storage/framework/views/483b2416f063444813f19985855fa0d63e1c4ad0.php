          ...
          <div class="card">
           <div class="row mb-2">
            ...
            <div class="card-body p-4" >
                <?php echo Form::open(array('route' => 'holidays.store','method'=>'POST')); ?>

                <div class="row">
                      <div class="com-md-4">
                        <label>Start Date:</label>
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input type="text" name="_datex" class="form-control datetimepicker-input" data-target="#reservationdate"  />
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/hrm/holidays/create.blade.php ENDPATH**/ ?>