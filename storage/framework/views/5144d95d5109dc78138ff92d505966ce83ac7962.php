  ...
  <div class="content ">
    ...
    <?php echo $__env->make('backend.message.message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="card-body p-4" >
                <?php echo Form::open(array('route' => 'hrm-grade.store','method'=>'POST')); ?>

                
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label><?php echo e(__('label._grade')); ?>:<span class="_required">*</span></label>
                                <input class="form-control" type="text" name="_grade" placeholder="<?php echo e(__('label._grade')); ?>" value="<?php echo e(old('_grade',$data->_grade ?? '' )); ?>" required>
                            </div>
                        </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\own\sabuz-bhai\sspf.sobuzsathitraders.com\sspf.sobuzsathitraders.com\resources\views/hrm/hrm-grade/create.blade.php ENDPATH**/ ?>