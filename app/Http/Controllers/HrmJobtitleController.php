...
class HrmJobtitleController extends Controller
{
   ...
   public function index(Request $request)
    {
        ...
        $page_name = $this->page_name;
         $datas = HrmJobtitle::orderBy('id','ASC')->get();
