...
class CreateIndividualReplaceOldItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('individual_replace_old_items', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('_warranty_date')->nullable();
            ...
            $table->string('_warranty_comment',250)->nullable();
    ...
    {
        Schema::dropIfExists('individual_replace_old_items');
    }
}
