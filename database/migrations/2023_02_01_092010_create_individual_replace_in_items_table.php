...
class CreateIndividualReplaceInItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('individual_replace_in_items', function (Blueprint $table) {
            $table->id();
            ...
            $table->tinyInteger('_in_status')->default(0);
    ...
    {
        Schema::dropIfExists('individual_replace_in_items');
    }
}
