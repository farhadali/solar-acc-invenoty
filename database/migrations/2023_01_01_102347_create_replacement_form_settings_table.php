...
class CreateReplacementFormSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('replacement_form_settings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('replacement_form_settings');
    }
}
