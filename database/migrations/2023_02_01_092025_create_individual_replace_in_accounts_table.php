...
class CreateIndividualReplaceInAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('individual_replace_in_accounts', function (Blueprint $table) {
             $table->id();
    ...
    {
        Schema::dropIfExists('individual_replace_in_accounts');
    }
}
