...
class CreateMaterialIssueReturnSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('material_issue_return_settings', function (Blueprint $table) {
            ...
            $table->integer('_show_payment_terms')->default(0);
    ...
    {
        Schema::dropIfExists('material_issue_return_settings');
    }
}
