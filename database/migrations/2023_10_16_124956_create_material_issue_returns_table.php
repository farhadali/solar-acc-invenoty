...
class CreateMaterialIssueReturnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('material_issue_returns', function (Blueprint $table) {
             $table->id();
    ...
    {
        Schema::dropIfExists('material_issue_returns');
    }
}
