...
class CreateImportPuchaseAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('import_puchase_accounts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('import_puchase_accounts');
    }
}
