...
class CreateHrmMonthlySalaryDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hrm_monthly_salary_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('hrm_monthly_salary_details');
    }
}
