...
class CreateSalesReturnAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_return_accounts', function (Blueprint $table) {
             $table->id();
    ...
    {
        Schema::dropIfExists('sales_return_accounts');
    }
}
