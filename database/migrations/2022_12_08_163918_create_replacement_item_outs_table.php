...
class CreateReplacementItemOutsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('replacement_item_outs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('replacement_item_outs');
    }
}
