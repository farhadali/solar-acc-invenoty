...
class CreateWarrantyAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warranty_accounts', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('_no');
            $table->foreign('_no')->references('id')->on('warranty_masters');
    ...
    {
        Schema::dropIfExists('warranty_accounts');
    }
}
