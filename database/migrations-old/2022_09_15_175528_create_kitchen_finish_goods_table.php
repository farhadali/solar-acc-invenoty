...
class CreateKitchenFinishGoodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kitchen_finish_goods', function (Blueprint $table) {
           $table->id();
    ...
    {
        Schema::dropIfExists('kitchen_finish_goods');
    }
}
