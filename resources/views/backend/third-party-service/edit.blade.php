          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
                 <a target="__blank" href="{{url('third-party-service/print')}}/{{$data->id}}" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
             ...
             <li class="breadcrumb-item ">
              ...
              <li class="breadcrumb-item ">
                        <a title="Add New" class="btn btn-success btn-sm" href="{{ route('third-party-service.create') }}"> <i class="nav-icon fas fa-plus"></i> </a>
               </li>
              @endcan
              <li class="breadcrumb-item ">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{url('third-party-service/update')}}" method="POST" class="purchase_form" >
                @csrf
                      <div class="row">

                       <div class="col-xs-12 col-sm-12 col-md-3">
                        <input type="hidden" name="_form_name" class="_form_name" value="service_masters">
                        <input type="hidden" name="_purchase_id" class="_form_name" value="{{$data->id}}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 mb-2">
                            <div class="form-group">
                              ...
                              <select name="_service_status" class="_service_status form-control" required>
                                ...
                                <option value="{{$key}}" @if($key==$data->_service_status) selected @endif >{{$val}}</option>
                                @empty
                                @endforelse
                              </select>
                            </div>
 ...
 <script type="text/javascript">
  $('#<?php echo ($m_key+1);?>__barcode').amsifySuggestags({
      ...
      showPlusAfter: 1,
                      ...
                      @include('backend.third-party-service.edit_ac_cb')
                         
                      @else
                       @include('backend.third-party-service.edit_ac_detail')
                      @endif
