          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               @endif
               <form action="{{route('item-replace.store')}}" method="POST" class="purchase_form" >
                @csrf
                    <div class="row">
                ...
                <input type="hidden" id="_search_form_value" name="_search_form_value" class="_search_form_value" value="2" >
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-2 @if(sizeof($permited_branch) == 1) display_none @endif" >
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-2 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_search_order_ref_id" name="_search_order_ref_id" class="form-control _search_order_ref_id" value="{{old('_order_ref_id')}}" placeholder="Complain Number" required>
                              <input type="hidden" id="_order_ref_id" name="_order_ref_id" class="form-control _order_ref_id" value="{{old('_order_ref_id')}}" placeholder="Purchase Order" required>
                      ...
                      @include('backend.item-replace.replace_item')
                        
                      @if($__user->_ac_type==1)
                      @include('backend.item-replace.create_acc_cb')
                         
                      @else
                       @include('backend.item-replace.create_acc_detail')
                      @endif
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-10">
                          <table class="table" style="border-collapse: collapse;margin: 0px auto;">
                            ...
                            <tr>
                              ...
                              <td style="border:0px;width: 80%;">
                                <input type="number" name="_discount_input" class="form-control width_200_px" id="_discount_input" value="0" >
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td style="border:0px;width: 20%;"><label for="_total">Net Total [New Price-Old Price] </label></td>
                              <td style="border:0px;width: 80%;">
