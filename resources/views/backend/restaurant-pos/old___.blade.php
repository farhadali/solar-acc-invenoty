...
<body class="skin-blue layout-top-nav pace-done" style="height: auto;" cz-shortcut-listen="true">
						...
						<div class="box box-primary">
                            ...
                            <div class="search_box_main_ledger" style="margin-top: 40px;"> </div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<div class="col-sm-12" style="overflow-y: auto;height: 260px;margin-top: -20px;">
    ...
    padding: 5px;
								    ...
								    ">
								    <div class="row" style="background:#0986a273;
    padding-top: 15px;
    margin-left: -10px;
    margin-right: -10px;
    border-right: 2px solid #FFF;
									...
									<div class="row">
										...
										<div class="col-md-3 text-right">
											<label style="display: flex;">
												Discount:<input style="height: 28px;padding: 6px 12px; font-size: 14px;" type="text" name="__total_discount" class="__total_discount form-control" id="__total_discount" placeholder="Discount">
