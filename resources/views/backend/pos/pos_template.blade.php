...
<tr>
  <td style="border:1px dotted grey;" colspan="5" class="text-left" >  Developed By:{{ $settings->name ?? '' }}</td>
            ...
            <input type="hidden" id="___base_url" value="{{url('sales/print')}}/{{$data->id}}">
        </section>

<script type="text/javascript">
  function printDiv(divID) {
        var url=$("#___base_url").val();
        var print_done =window.open(""+url+"", "_blank", "scrollbars=1,resizable=1,height=300,width=450");
