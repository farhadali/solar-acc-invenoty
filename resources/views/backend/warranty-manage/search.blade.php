              ...
              <div class="modal-content">
                ...
                <div class="modal-body search_modal">
                 @php 
                  ...
                  <div class="form-group row">
                    <label for="id" class="col-sm-2 col-form-label">Complain No:</label>
                    <div class="col-sm-10">
                      <input type="text" id="_order_number" name="_order_number" class="form-control" placeholder="Search By Complain No" 
                  ...
                  <div class="form-group row">
                    <label for="_lock" class="col-sm-2 col-form-label">Warranty Status:</label>
                    <div class="col-sm-10">
                     
                       <select id="_lock" class="form-control" name="_waranty_status" >
                        <option value="">Select</option>
                            @foreach(_warranty_status() AS $key=>$val)
                            <option value="{{$key}}" @if(isset($request->_waranty_status)) @if($key==$request->_waranty_status) selected @endif @endif >{{$val}}</option>
                        @endforeach
                        </select>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      @php
             $cloumns = [ 'id'=>'ID','_date'=>'Date','_waranty_status'=>'Waranty Status','_user_name'=>'User name','_order_ref_id'=>'Order Refarance','_referance'=>'Referance','_note'=>'Note', '_branch_id '=>'Branch','_ledger_id'=>'Ledger','_store_id'=>'Store','_cost_center_id'=>'Cost Center'];
                          ...
                          <div class="col-md-8">
                              <div class="form-group ">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="{{url('warranty-manage-reset')}}" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
