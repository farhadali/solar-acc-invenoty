        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                 {!! Form::open(array('route' => 'warranty-manage.store','method'=>'POST')) !!}
                    <div class="row">
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-2">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_sales_date" name="_sales_date" class="form-control _sales_date" value="{{old('_sales_date','')}}" placeholder="Sales Date" readonly>
                                      ...
                                      <table class="table table-bordered">
                                          ...
                                          <tbody class="area__purchase_details" id="area__purchase_details">
                                            <tr class="_purchase_row _purchase_row__">
                                              ...
                                              <td class="">
                                                <input type="text" name="_warranty_reason[]" class="form-control _warranty_reason ">
                                              </td>
                    ...
                    @if($__user->_ac_type==1)
                      @include('backend.warranty-manage.create_acc_cb')
                         
                      @else
                       @include('backend.warranty-manage.create_acc_detail')
                      @endif
...
<script type="text/javascript">
  ...
  request.done(function( result ) {
    ...
    if(result?.length > 0){
      ...
      alert('This Item Is Not available in Sales List');
      $("#_serach_baorce").val("");
    }
    ...
    var _item_row_count = (i+1);
       ...
       $(document).find("#area__purchase_details").append(`<tr class="_purchase_row">
                                              ...
                                              <td class="">
                                                ...
                                                <input type="text" name="${_item_row_count}__barcode__${data[i]._p_p_l_id}" class="form-control _barcode ${_item_row_count}__barcode " id="${_item_row_count}__barcode" value="${data[i]._barcode}" >
