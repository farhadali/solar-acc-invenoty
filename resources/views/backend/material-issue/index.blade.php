          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
              ...
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="{{ route('material-issue.create') }}"> Add New </a>
               </li>
              @endcan
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                       @include('backend.material-issue.search')
                    </div>
                    <div class="col-md-8">
                      <div class="d-flex flex-row justify-content-end">
                         @can('material-issue-print')
                          ...
                          <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item " href="{{url('material-issue/print')}}/{{$data->id}}" >
                                         View & Print
                                      </a>
                                     
                                     <a class="dropdown-item " href="{{url('net-sales-after-return')}}/{{$data->id}}" >
                                         Net Sales After Return
                                      </a>
                                     <a class="dropdown-item " href="{{url('material-issue/challan')}}/{{$data->id}}" >
                                         Challan
                                      </a>
                                     @can('material-issue-edit')
                                        <a class="dropdown-item " href="{{ route('material-issue.edit',$data->id) }}" >
                                          Edit
                                        </a>
                                    @endcan
