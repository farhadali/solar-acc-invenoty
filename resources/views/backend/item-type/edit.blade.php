          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">
                 <a class="btn btn-primary" href="{{ route('item-type.index') }}"> <i class="fa fa-th-list" aria-hidden="true"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  {!! Form::model($data, ['method' => 'PATCH','route' => ['item-type.update', $data->id]]) !!} 
                    @csrf
                    <div class="row">
                       <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('_detail', null, array('placeholder' => __('label._detail'),'class' => 'form-control')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-2">
                            <div class="form-group">
                                <label for="_status">{{__('label._status')}}:</label>
