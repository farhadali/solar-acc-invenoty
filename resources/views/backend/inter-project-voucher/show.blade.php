          ...
          <div class="col-lg-12">
            <div class="card">
             <div class="card-header">
                <div class="row">
                  <div class="col-md-6">
                     <h4><a  href="{{ route('inter-project-voucher.index') }}"> {!! $page_name ?? '' !!} </a>  
                  ...
                  <div class="col-md-6">
                   <div class="d-flex right" style="float: right;">
                       @can('inter-project-voucher-create')
                        <a title="Add New" class="btn  btn-sm btn-success  mr-3" href="{{ route('inter-project-voucher.create') }}"> <i class="nav-icon fa fa-plus"></i> </a>
                      @endcan
                      @can('inter-project-voucher-edit')
                                    <a title="Edit" class="btn  btn-default  mr-3" href="{{ route('inter-project-voucher.edit',$data->id) }}">
                      ...
                      @can('inter-project-voucher-list')
                       <a class="btn btn-sm btn-primary" title="List" href="{{ route('inter-project-voucher.index') }}"> <i class="nav-icon fa fa-th-list" aria-hidden="true"></i></a>
                       @endcan
                    </div>
