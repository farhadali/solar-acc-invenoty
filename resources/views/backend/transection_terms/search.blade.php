              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                 @php 
                  ...
                  <div class="form-group row">
                    <label for="_detail" class="col-sm-2 col-form-label">Detail:</label>
                    <div class="col-sm-10">
                      <input type="text" id="_detail" name="_detail" class="form-control" placeholder="Search By Detail" value="@if(isset($request->_detail)) {{$request->_detail ?? ''}}  @endif">
                    </div>
                  </div>
                    ...
                    <div class="col-sm-10">
                      @php
                      $cloumns = [ 'id'=>'ID','_name'=>'Name','_detail'=>'Detail'];
                          ...
                          <div class="col-md-8">
                              <div class="form-group mt-1">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="{{url('transection_terms-reset')}}" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
