                              ...
                              <td colspan="4" class=" text-right"  style="width: 50%;">
                                  <table style="width: 100%">
                                    ...
                                    @if($data->_service_charge > 0)
                                      <tr>
                                        <td  class="text-right" ><b>Service Charge[+]</b></td>
                                        <td  class="text-right">{!! _report_amount($data->_service_charge ?? 0) !!}</td>
                                      </tr>
                                      @endif
                                      @if($data->_other_charge > 0)
                                      <tr>
                                        <td  class="text-right" ><b>Other Charge[+]</b></td>
                                        <td  class="text-right">{!! _report_amount($data->_other_charge ?? 0) !!}</td>
                                      </tr>
                                      @endif
                                      @if($data->_delivery_charge > 0)
                                      <tr>
                                        <td  class="text-right" ><b>Delivery Charge[+]</b></td>
                                        <td  class="text-right">{!! _report_amount($data->_delivery_charge ?? 0) !!}</td>
                                      </tr>
                                      @endif
                                    <tr>
