          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
              ...
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="{{ route('restaurant-sales.create') }}"> Add New </a>
               </li>
              @endcan
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                       @include('backend.restaurant-sales.search')
                    </div>
                    <div class="col-md-8">
                      <div class="d-flex flex-row justify-content-end">
                         @can('restaurant-sales-print')
                          ...
                          <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item " target="__blank" href="{{url('restaurant-sales/print')}}/{{$data->id}}" >
                                         View & Print
                                      </a>
                                     <a class="dropdown-item " target="__blank" href="{{url('kitchen-slip')}}/{{$data->id}}" >
                                        Kitchen Slip
                                      </a>
                                     <a class="dropdown-item " href="{{url('restaurant-sales/challan')}}/{{$data->id}}" >
                                         Challan
                                      </a>
                                     @can('restaurant-sales-edit')
                                        <a class="dropdown-item " href="{{ route('restaurant-sales.edit',$data->id) }}" >
                                          Edit
                                        </a>
                                    @endcan
                                     @can('money-receipt-print')
                                     
                                        <a class="dropdown-item " href="{{ url('restaurant-sales-money-receipt') }}/{{$data->id}}">
                                         Money Receipt
                                        </a>
...
function date__today(){
  ...
  $(document).on("click","._single_data_click",function(){
      ...
      $.ajaxSetup({ headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') } });
            $.ajax({
               type:'POST',
               url:"{{ url('restaurant-invoice-wise-detail') }}",
