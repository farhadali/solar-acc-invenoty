...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class=" col-sm-6 ">
            <a class="m-0 _page_name" href="{{ route('restaurant-sales.index') }}">{!! $page_name ?? '' !!} </a>
          </div><!-- /.col -->
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
                 <a target="__blank" href="{{url('restaurant-sales/print')}}/{{$data->id}}" class="btn btn-sm btn-warning"> <i class="nav-icon fas fa-print"></i> </a>
             ...
             <li class="breadcrumb-item ">
               ...
               @endcan
                @can('restaurant-sales-form-settings')
             <li class="breadcrumb-item ">
              ...
              <li class="breadcrumb-item ">
                        <a title="Add New" class="btn btn-success btn-sm" href="{{ route('restaurant-sales.create') }}"> <i class="nav-icon fas fa-plus"></i> </a>
               </li>
              @endcan
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="{{ route('restaurant-sales.index') }}"> <i class="nav-icon fas fa-list"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               <form action="{{url('restaurant-sales/update')}}" method="POST" class="purchase_form" >
                @csrf
                <div class="row">
                    @php
$users = \Auth::user();
...
@endphp 
                  <div class="col-xs-12 col-sm-12 col-md-4 @if(sizeof($permited_organizations)==1) display_none @endif">
                            <div class="form-group">
                                <label>{{__('label.organization')}}:</label>
                                <select  class="form-control organization_id " name="organization_id" >
                                   
                                    @forelse($permited_organizations as $key=> $val)
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-4 @if(sizeof($permited_branch)==1) display_none @endif">
                            <div class="form-group">
                                <label>Branch:</label>
                                <select  class="form-control _branch_id " name="_branch_id" >
                                   
                                    @forelse($permited_branch as $key=> $val)
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 @if(sizeof($permited_costcenters)==1) display_none @endif">
                            <div class="form-group">
                                ...
                                <select  class="form-control _main_cost_center_id " name="_main_cost_center_id" >
                                    ...
                                    <option value="{{$val->id}}" @if($data->_cost_center_id==$val->id) selected @endif>{{$val->_name}}</option>
                                    @empty
                                    @endforelse
                                  </select>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 @if(sizeof($store_houses)==1) display_none @endif">
                            <div class="form-group">
                                <label>Store:</label>
                                <select  class="form-control _master_store_id " name="_master_store_id" >
                                   
                                    @forelse($store_houses as $key=> $val)
                                    <option value="{{$val->id}}" @if($data->_store_id==$val->id) selected @endif>{{$val->_name}}</option>
                                    @empty
                                    @endforelse
                                  </select>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select  class="form-control _sales_spot " name="_sales_spot" >
                                    ...
                                    <option value="{{$key}}" @if($data->_sales_spot==$key) selected @endif>{{$val}}</option>
                                    @empty
                                    @endforelse
                                  </select>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group" style="display: flex;">
                                ...
                                <select  class="form-control _table_id select2" name="_table_id[]" multiple>
                                     @php
                                    $_table_ids = $data->_table_id ?? 0;
                                    if($_table_ids !=0){
                                      $_selected_tables = explode(",",$_table_ids);
                                    }else{
                                      $_selected_tables =[];
                                    }
                                    @endphp
                                    ...
                                    <option value="{{$table->id}}" @if(in_array($table->id,$_selected_tables)) selected @endif>{{$table->_name ?? ''}}</option>
                                    @empty
                                    @endforelse
                                  </select>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group"  style="display: flex;">
                                <strong>Steward/Waiter:</strong>
                                <select  class="form-control _served_by_ids select2" name="_served_by_ids[]" multiple>
                                     @php
                                    $_string_ids = $data->_served_by_ids ?? 0;
                                    if($_string_ids !=0){
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                            <div class="form-group">
                                ...
                                <select  class="form-control _delivery_status " name="_delivery_status" >
                                    ...
                                    @forelse(_delivery_status() as $key=> $val)
                                    <option value="{{$key}}"  @if($data->_delivery_status==$key) selected @endif>{{$val}}</option>
                                    @empty
                                    @endforelse
                                  </select>
                          ...
                          <table class="table" style="border-collapse: collapse;">
                              ...
                              <td style="width: 70%;border:0px;">
                                @if ($_print = Session::get('_print_value'))
                                    ...
                                    @if ($_master_id = Session::get('_master_id'))
                                     <input type="hidden" name="_master_id" value="{{url('restaurant-sales/print')}}/{{$_master_id}}" class="_master_id">
                            ...
                            <tr>
                              ...
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_service_charge" class="form-control width_200_px" id="_service_charge" value="{{$data->_service_charge ?? 0}}" >
                              </td>
                            </tr>
                            <tr>
                              <td style="border:0px;width: 20%;"><label for="_other_charge">Other Charge</label></td>
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_other_charge" class="form-control width_200_px" id="_other_charge" value="{{$data->_other_charge ?? 0}}" >
                              </td>
                            </tr>
                            <tr>
                              <td style="border:0px;width: 20%;"><label for="_delivery_charge">Delivery Charge</label></td>
                              <td style="border:0px;width: 80%;">
                                <input type="text" name="_delivery_charge" class="form-control width_200_px" id="_delivery_charge" value="{{$data->_delivery_charge ?? 0}}" >
                              </td>
                            </tr>
...
<div style="width: 100%;" class="modal  fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <form action="{{ url('restaurant-sales-settings')}}" method="POST">
        @csrf
    <div class="modal-content">
      <div class="modal-header">
...
var _item_row_count = parseFloat($(document).find('._item_row_count').val());
  ...
  function setting_data_fetch(){
      var request = $.ajax({
            url: "{{url('restaurant-sales-setting-modal')}}",
            method: "GET",
            dataType: "html"
          });
