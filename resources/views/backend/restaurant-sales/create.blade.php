          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               ...
               @endif -->
               <form action="{{route('restaurant-sales.store')}}" method="POST" class="purchase_form" >
                @csrf
                <div class="row">
@php
$users = \Auth::user();
                       ...
                       <div class="col-xs-12 col-sm-12 col-md-3 ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" id="_referance" name="_referance" class="form-control _referance" value="{{old('_referance','N/A')}}" placeholder="Referance" >
                            </div>
                        </div>
