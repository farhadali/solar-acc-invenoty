        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
               {!! Form::open(array('route' => 'w-item-receive-from-supp.store','method'=>'POST')) !!}
                <div class="row">
