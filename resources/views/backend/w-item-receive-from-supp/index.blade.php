        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
               @can('w-item-receive-from-supp-create')
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="{{ route('w-item-receive-from-supp.create') }}"> Add New </a>
               </li>
              @endcan
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                       @include('backend.w-item-receive-from-supp.search')
                    </div>
                    <div class="col-md-8">
                      <div class="d-flex flex-row justify-content-end">
                         @can('w-item-receive-from-supp-print')
                             ...
                             <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    @can('w-item-receive-from-supp-edit')
                                        <a class="dropdown-item " href="{{ route('w-item-receive-from-supp.edit',$data->id) }}" >
                                          Edit
                                        </a>
                                    @endcan
                                     <a class="dropdown-item " href="{{url('w-item-receive-from-supp-in-report')}}/{{$data->id}}" >
                                         Individual Replacement In Report
                                      </a>
                                      
                                     <a class="dropdown-item " href="{{url('w-item-receive-from-supp-print')}}/{{$data->id}}" >
                                         Details
                                      </a>
...
$(document).on("click","._single_data_click",function(){
      ...
      if(has_class){return false; }
        ...
        $.ajax({
           type:'POST',
           url:"{{ url('w-item-receive-from-supp-wise-detail') }}",
