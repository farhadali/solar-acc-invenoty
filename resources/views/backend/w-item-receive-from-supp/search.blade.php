              ...
              <div class="modal-content">
                ...
                <div class="modal-body search_modal">
                 @php 
                  ...
                  <div class="form-group row">
                    <label for="_order_number" class="col-sm-3 col-form-label">Order Number:</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group row">
                    <label for="_phone" class="col-sm-3 col-form-label">Mobile No:</label>
                    <div class="col-sm-9">
                      <input type="text" id="_phone" name="_phone" class="form-control" placeholder="Search By Mobile" value="@if(isset($request->_phone)){{$request->_phone ?? ''}} @endif">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="_phone" class="col-sm-3 col-form-label">Status:</label>
                    <div class="col-sm-9">
                      <select name="_service_status" class="form-control">
                        <option value="">Select Status</option>
                        @forelse(_service_status() as $key=>$val)
                        <option value="{{$key}}" @if(isset($request->_service_status)) @if($key==$request->_service_status) selected @endif @endif >{{$val}}</option>
                        @empty
                        @endforelse
                      </select>
                    </div>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      @php
             $cloumns = [ 'id'=>'ID','_date'=>'Date','_user_name'=>'User name','_order_number'=>'Order Number', '_branch_id '=>'Branch','_ledger_id'=>'Ledger'];
                          ...
                          <div class="col-md-8">
                              <div class="form-group ">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#modal-default" title="Advance Search"><i class="fa fa-search mr-2"></i> </button>
                                     <a href="{{url('third-party-service')}}" class="btn btn-sm btn-danger" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                              </div>
                          </div>
                        </div><!-- end row -->
