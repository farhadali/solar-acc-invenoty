...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class=" col-sm-6 ">
              <a class="m-0 _page_name" href="{{ route('w-item-receive-from-supp.index') }}">{!! $page_name ?? '' !!} </a>
          ...
          <div class=" col-sm-6 ">
            <ol class="breadcrumb float-sm-right">
             ...
             <li class="breadcrumb-item ">
               ...
               @endcan
                @can('w-item-receive-from-supp-form-settings')
             <li class="breadcrumb-item ">
              ...
              @endcan
              <li class="breadcrumb-item ">
                 <a class="btn btn-sm btn-success" title="List" href="{{ route('w-item-receive-from-supp.index') }}"> <i class="nav-icon fas fa-list"></i> </a>
               </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
              <form action="{{url('w-item-receive-from-supp/update')}}" method="post">
                @csrf
                <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-2">
                        <input type="hidden" name="_form_name" class="_form_name"  value="individual_replace_masters">
                        <input type="hidden" name="_master_id" class="_form_name"  value="{{$data->id}}">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-2 ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 ">
                            <div class="form-group">
                              ...
                              <input type="text" required id="_search_order_ref_id" name="_search_order_ref_id" class="form-control _search_order_ref_id" value="{{old('_order_ref_id',$data->_order_ref_id)}}" placeholder="Complain No" >
                              <input type="hidden" id="_order_ref_id" name="_order_ref_id" class="form-control _order_ref_id" value="{{old('_order_ref_id',$data->_order_ref_id)}}" placeholder="Complain No" >
                  ...
                  <div class="col-md-6 box_shadow"> <!-- Old item information -->
                    <h4 class="text-center">Old Item Information</h4>
                     @include('backend.w-item-receive-from-supp.edit_item_old')
                  </div> <!-- Old item information -->

                  <div class="col-md-6 box_shadow"> <!-- Individual Stock In -->
                    <h4 class="text-center">Individual Stock In</h4>
                      @include('backend.w-item-receive-from-supp.edit_item_in')
                ...
                <div class="form-group row ">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="_note" required class="form-control" id="_note" placeholder="Note" value="{{$data->_note ?? '' }}">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="{{ url('w-item-receive-from-supp-settings')}}" method="POST">
        @csrf
...
$("#_in_qty ").val(1)
$("#_in_rate ").val(_item_rate)
$("#_in_sales_rate").val(_item_sales_rate)
$("#_in_vat").val(_item_vat)
$("#_in_vat_amount").val(_item_vat)
$("#_in_value").val(_item_rate)
...
$("#_out_qty ").val(1)
$("#_out_rate ").val(_item_rate)
$("#_out_sales_rate").val(_item_sales_rate)
$("#_out_vat").val(_item_vat)
$("#_out_vat_amount").val(_item_vat)
$("#_out_value").val(_item_sales_rate)
