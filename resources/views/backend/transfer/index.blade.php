          ...
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
              ...
              <li class="breadcrumb-item active">
                  <a title="Add New" class="btn btn-info btn-sm" href="{{ route('transfer.create') }}"> Add New </a>
               </li>
              @endcan
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                       @include('backend.transfer.search')
                    </div>
                    <div class="col-md-8">
                             ...
                             <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item " href="{{url('transfer/print')}}/{{$data->id}}" >
                                         View & Print
                                      </a>
                                     <a class="dropdown-item " href="{{url('transfer/stock-in')}}/{{$data->id}}" >
                                         Stock In Print Print
                                      </a>
                                     <a class="dropdown-item " href="{{url('transfer/stock-out')}}/{{$data->id}}" >
                                         Stock Out Print
                                      </a>
                                     @can('transfer-edit')
                                        <a class="dropdown-item " href="{{ route('transfer.edit',$data->id) }}" >
                                          Edit
                                        </a>
                                    @endcan
