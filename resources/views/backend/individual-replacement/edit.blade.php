        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
              <form action="{{url('individual-replacement/update')}}" method="post">
                @csrf
                <div class="row">
