                  ...
                  <table class="table table-bordered _list_table">
                     <thead>
                        <tr>
                         ...
                         <th class=""><b>{{__('label._number_of_days')}}</b></th>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              @can('leave-type-delete')
                                 {!! Form::open(['method' => 'DELETE','route' => ['leave-type.destroy', $data->id],'style'=>'display:inline']) !!}
                                      <button onclick="return confirm('Are you sure?')" type="submit" class="btn btn-sm btn-default"><i class="fa fa-trash _required"></i></button>
                                  {!! Form::close() !!}
                               @endcan 
                              <a  type="button" 
                                  href="{{ route('leave-type.show',$data->id) }}"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>

                             @can('leave-type-edit')
                                  <a  type="button" 
                                  href="{{ route('leave-type.edit',$data->id) }}"
