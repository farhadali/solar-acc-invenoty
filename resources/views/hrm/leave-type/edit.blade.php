  ...
  <div class="content ">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
           <div class="row mb-2">
                  <div class="col-sm-6">
                    <a class="m-0 _page_name" href="{{ route('leave-type.index') }}">{!! $page_name !!} </a>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
    ...
    @include('backend.message.message')
            ...
            <div class="card-body p-4" >
               {!! Form::model($data, ['method' => 'PATCH','route' => ['leave-type.update', $data->id]]) !!}
                <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label> {{__('label._type')}}:</label>
                                {!! Form::text('_type', null, array('placeholder' => __('label._type'),'class' => 'form-control','required' => 'true')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>{{__('label._number_of_days')}}:</label>
                                {!! Form::text('_number_of_days', null, array('placeholder' => __("label._number_of_days"),'class' => 'form-control','required' => 'true')) !!}
                            </div>
                        </div>
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
