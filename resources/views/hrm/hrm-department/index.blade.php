        ...
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
               @can('hrm-department-create')
             <li class="breadcrumb-item active">
                <a type="button" 
               class="btn btn-sm btn-info" 
              
               href="{{ route('hrm-department.create') }}">
                     ...
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              @can('hrm-department-delete')
                                 {!! Form::open(['method' => 'DELETE','route' => ['hrm-department.destroy', $data->id],'style'=>'display:inline']) !!}
                                      <button onclick="return confirm('Are you sure?')" type="submit" class="btn btn-sm btn-default"><i class="fa fa-trash _required"></i></button>
                                  {!! Form::close() !!}
                               @endcan 
                              <a  type="button" 
                                  href="{{ route('hrm-department.show',$data->id) }}"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>

                             @can('hrm-department-edit')
                                  <a  type="button" 
                                  href="{{ route('hrm-department.edit',$data->id) }}"
