  ...
  <div class="content ">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
           <div class="row mb-2">
                  <div class="col-sm-6">
                    <a class="m-0 _page_name" href="{{ route('hrm-department.index') }}">{!! $page_name !!} </a>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
    ...
    @include('backend.message.message')
            ...
            <div class="card-body p-4" >
               {!! Form::model($data, ['method' => 'PATCH','route' => ['hrm-department.update', $data->id]]) !!}
                <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>{{__('label._department')}}:<span class="_required">*</span></label>
                                <input class="form-control" type="text" name="_department" placeholder="{{__('label._department')}}" value="{{old('_department',$data->_department ?? '' )}}" required>
                            </div>
                        </div>
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="_details" placeholder="{{__('label._details')}}" value="{{old('_details',$data->_details ?? '' )}}">
                            </div>
                        </div>
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
