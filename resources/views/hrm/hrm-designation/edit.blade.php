  ...
  <div class="content ">
    ...
    @include('backend.message.message')
            ...
            <div class="card-body p-4" >
               {!! Form::model($data, ['method' => 'PATCH','route' => ['hrm-designation.update', $data->id]]) !!}
                <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <label>{{__('label.name')}}:<span class="_required">*</span></label>
                                <input class="form-control" type="text" name="_name" placeholder="{{__('label.name')}}" value="{{old('_name',$data->_name ?? '' )}}" required>
                            </div>
                        </div>
