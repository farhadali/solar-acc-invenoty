      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            <a class="m-0 _page_name" href="{{ route('hrm-designation.index') }}">{!! $page_name ?? '' !!} </a>
            <ol class="breadcrumb float-sm-right ml-2">
               @can('hrm-designation-create')
             <li class="breadcrumb-item active">
                <a type="button" 
               class="btn btn-sm btn-info" 
              
               href="{{ route('hrm-designation.create') }}">
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                      @include('hrm.hrm-designation.search')
                    </div>
                    <div class="col-md-8">
                     ...
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              @can('hrm-designation-delete')
                                 {!! Form::open(['method' => 'DELETE','route' => ['hrm-designation.destroy', $data->id],'style'=>'display:inline']) !!}
                                      <button onclick="return confirm('Are you sure?')" type="submit" class="btn btn-sm btn-default"><i class="fa fa-trash _required"></i></button>
                                  {!! Form::close() !!}
                               @endcan 
                              <a  type="button" 
                                  href="{{ route('hrm-designation.show',$data->id) }}"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>

                             @can('hrm-designation-edit')
                                  <a  type="button" 
                                  href="{{ route('hrm-designation.edit',$data->id) }}"
