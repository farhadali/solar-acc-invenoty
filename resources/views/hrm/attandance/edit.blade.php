    ...
    <div class="form-group row pt-2">
                            <label class="col-sm-2 col-form-label" >{{__('EMP ID')}}:</label>
                             <div class="col-sm-6">
                                ...
                                <input type="text" name="_employee_id_text" class="form-control _employee_id_text" placeholder="{{__('EMP ID')}}" value="{{old('_employee_id_text',$data->_number ?? '')}}" required>
    ...
    <div class="form-group row">
            ...
            <div class="col-sm-2 ">
                <select class="form-control" name="_type" id="_type" required>
                  <option value="1" @if($data->_type==1) selected @endif >IN</option>
                  <option value="2" @if($data->_type==2) selected @endif >OUT</option>
                </select>
            </div>
    </div>
     ...
     <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input class="form-group" type="datetime-local" id="_datetime" name="_datetime" value="{{old('_datetime',$data->_datetime)}}" required>
        </div>
</div>
