      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            <a class="m-0 _page_name" href="{{ route('hrm-grade.index') }}">{!! $page_name ?? '' !!} </a>
            <ol class="breadcrumb float-sm-right ml-2">
               @can('hrm-grade-create')
             <li class="breadcrumb-item active">
                <a type="button" 
               class="btn btn-sm btn-info" 
              
               href="{{ route('hrm-grade.create') }}">
                  ...
                  <table class="table table-bordered _list_table">
                     <thead>
                        <tr>
                         ...
                         <th class=""><b>{{__('label._grade')}}</b></th>
                     ...
                     <tbody>
                        ...
                        <tr>
                             ...
                             <td style="display: flex;">
                              @can('hrm-grade-delete')
                                 {!! Form::open(['method' => 'DELETE','route' => ['hrm-grade.destroy', $data->id],'style'=>'display:inline']) !!}
                                      <button onclick="return confirm('Are you sure?')" type="submit" class="btn btn-sm btn-default"><i class="fa fa-trash _required"></i></button>
                                  {!! Form::close() !!}
                               @endcan 
                              <a  type="button" 
                                  href="{{ route('hrm-grade.show',$data->id) }}"
                                  class="btn btn-sm btn-default  mr-1"><i class="fa fa-eye"></i></a>

                             @can('hrm-grade-edit')
                                  <a  type="button" 
                                  href="{{ route('hrm-grade.edit',$data->id) }}"
